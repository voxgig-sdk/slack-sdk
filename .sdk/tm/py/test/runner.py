...
class SlackTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SlackTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SlackTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SlackTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
