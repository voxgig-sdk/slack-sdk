...
from projectname_sdk.core.control import SlackControl
...
class SlackContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, SlackResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SlackError(code, msg, self)
