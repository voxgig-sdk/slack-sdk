...
class SlackFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SlackSDK/1.0)';
    ...
    public static function call(SlackContext $ctx, string $fullurl, array $fetchdef): array
    {
