...
class SlackRatelimitFeature extends SlackBaseFeature
{
    ...
    private function _acquire(SlackContext $ctx): void
    {
    ...
    private function _track(SlackContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
