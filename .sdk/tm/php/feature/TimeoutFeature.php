...
class SlackTimeoutFeature extends SlackBaseFeature
{
    ...
    private function _with_timeout(SlackContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SlackContext $_ctx, float $ms): void
    {
        $client = $this->client;
