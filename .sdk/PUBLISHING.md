...
|---|---|---|
| `js/` | @voxgig-sdk/slack-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/slack | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/slack-js \
      --repository voxgig-sdk/slack-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/slack-js` shows it, and
`npm trust revoke @voxgig-sdk/slack-js --id=<id>` removes it.
