# Slack SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SlackSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SlackSDK(...) and SlackSDK.test(...) become
#      SlackSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_ENTITIES = {
    ...
    "Adminappsrequest": "adminappsrequest",
    "Adminappsrestricted": "adminappsrestricted",
    "Adminconversation": "adminconversation",
    "Adminconversationsekm": "adminconversationsekm",
    "AdminconversationsrestrictAccess": "adminconversationsrestrict_access",
    "Adminemoji": "adminemoji",
    "AdmininviteRequest": "admininvite_request",
    "AdmininviteRequestsapproved": "admininvite_requestsapproved",
    "AdmininviteRequestsdenied": "admininvite_requestsdenied",
    "Adminteam": "adminteam",
    "Adminteamsadmin": "adminteamsadmin",
    "Adminteamsowner": "adminteamsowner",
    "Adminteamssetting": "adminteamssetting",
    "Adminuser": "adminuser",
    "Adminusergroup": "adminusergroup",
    "Adminuserssession": "adminuserssession",
    "Api": "api",
    "App": "app",
    "Appseventauthorization": "appseventauthorization",
    "Appspermission": "appspermission",
    "Appspermissionsresource": "appspermissionsresource",
    "Appspermissionsscope": "appspermissionsscope",
    "Appspermissionsuser": "appspermissionsuser",
    "Auth": "auth",
    "Bot": "bot",
    "Call": "call",
    "Callsparticipant": "callsparticipant",
    "Chat": "chat",
    "ChatscheduledMessage": "chatscheduled_message",
