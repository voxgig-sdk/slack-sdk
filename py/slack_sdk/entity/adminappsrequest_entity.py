...
class AdminappsrequestEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminappsrequestEntity(self._client, opts)
    ...
    def data_get(self) -> Adminappsrequest:
    ...
    def match_get(self) -> Adminappsrequest:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Adminappsrequest:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Adminappsrequest().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
