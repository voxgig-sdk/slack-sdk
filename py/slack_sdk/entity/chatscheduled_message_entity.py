...
class ChatscheduledMessageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ChatscheduledMessageEntity(self._client, opts)
    ...
    def data_get(self) -> ChatscheduledMessage:
    ...
    def match_get(self) -> ChatscheduledMessage:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ChatscheduledMessage]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ChatscheduledMessage().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
