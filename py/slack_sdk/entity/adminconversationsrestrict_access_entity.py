...
from slack_sdk.slack_types import (
...
class AdminconversationsrestrictAccessEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminconversationsrestrictAccessEntity(self._client, opts)
    ...
    def data_get(self) -> AdminconversationsrestrictAccess:
    ...
    def match_get(self) -> AdminconversationsrestrictAccess:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AdminconversationsrestrictAccess:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AdminconversationsrestrictAccess().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: AdminconversationsrestrictAccessCreateData, ctrl=None) -> AdminconversationsrestrictAccess:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
