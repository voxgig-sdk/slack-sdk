...
class AppspermissionsuserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AppspermissionsuserEntity(self._client, opts)
    ...
    def data_get(self) -> Appspermissionsuser:
    ...
    def match_get(self) -> Appspermissionsuser:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Appspermissionsuser:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Appspermissionsuser().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
