...
class UsersprofileEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UsersprofileEntity(self._client, opts)
    ...
    def data_get(self) -> Usersprofile:
    ...
    def match_get(self) -> Usersprofile:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Usersprofile:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Usersprofile().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: UsersprofileCreateData, ctrl=None) -> Usersprofile:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
