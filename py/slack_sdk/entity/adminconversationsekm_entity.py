...
class AdminconversationsekmEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminconversationsekmEntity(self._client, opts)
    ...
    def data_get(self) -> Adminconversationsekm:
    ...
    def match_get(self) -> Adminconversationsekm:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Adminconversationsekm:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Adminconversationsekm().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
