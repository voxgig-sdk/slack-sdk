...
class AppspermissionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AppspermissionEntity(self._client, opts)
    ...
    def data_get(self) -> Appspermission:
    ...
    def match_get(self) -> Appspermission:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Appspermission:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Appspermission().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
