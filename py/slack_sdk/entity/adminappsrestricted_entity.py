...
class AdminappsrestrictedEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminappsrestrictedEntity(self._client, opts)
    ...
    def data_get(self) -> Adminappsrestricted:
    ...
    def match_get(self) -> Adminappsrestricted:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Adminappsrestricted:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Adminappsrestricted().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
