...
class AppspermissionsscopeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AppspermissionsscopeEntity(self._client, opts)
    ...
    def data_get(self) -> Appspermissionsscope:
    ...
    def match_get(self) -> Appspermissionsscope:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Appspermissionsscope:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Appspermissionsscope().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
