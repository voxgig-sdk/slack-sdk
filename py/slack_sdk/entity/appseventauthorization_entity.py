...
class AppseventauthorizationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AppseventauthorizationEntity(self._client, opts)
    ...
    def data_get(self) -> Appseventauthorization:
    ...
    def match_get(self) -> Appseventauthorization:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Appseventauthorization:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Appseventauthorization().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
