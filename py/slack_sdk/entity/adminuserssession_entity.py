...
class AdminuserssessionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminuserssessionEntity(self._client, opts)
    ...
    def data_get(self) -> Adminuserssession:
    ...
    def match_get(self) -> Adminuserssession:
    ...
    def create(self, reqdata: AdminuserssessionCreateData, ctrl=None) -> Adminuserssession:
        utility = self._utility
