...
class FilescommentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FilescommentEntity(self._client, opts)
    ...
    def data_get(self) -> Filescomment:
    ...
    def match_get(self) -> Filescomment:
    ...
    def create(self, reqdata: FilescommentCreateData, ctrl=None) -> Filescomment:
        utility = self._utility
