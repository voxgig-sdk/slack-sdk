...
class AdminappsapprovedEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminappsapprovedEntity(self._client, opts)
    ...
    def data_get(self) -> Adminappsapproved:
    ...
    def match_get(self) -> Adminappsapproved:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Adminappsapproved:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Adminappsapproved().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
