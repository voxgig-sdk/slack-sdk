...
class ConversationsinfoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsinfoEntity(self._client, opts)
    ...
    def data_get(self) -> Conversationsinfo:
    ...
    def match_get(self) -> Conversationsinfo:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Conversationsinfo:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Conversationsinfo().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
