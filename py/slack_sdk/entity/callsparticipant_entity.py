...
class CallsparticipantEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CallsparticipantEntity(self._client, opts)
    ...
    def data_get(self) -> Callsparticipant:
    ...
    def match_get(self) -> Callsparticipant:
    ...
    def create(self, reqdata: CallsparticipantCreateData, ctrl=None) -> Callsparticipant:
        utility = self._utility
