...
class AdminusergroupEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminusergroupEntity(self._client, opts)
    ...
    def data_get(self) -> Adminusergroup:
    ...
    def match_get(self) -> Adminusergroup:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Adminusergroup:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Adminusergroup().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: AdminusergroupCreateData, ctrl=None) -> Adminusergroup:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
