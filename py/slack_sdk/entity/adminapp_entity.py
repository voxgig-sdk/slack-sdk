...
class AdminappEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminappEntity(self._client, opts)
    ...
    def create(self, reqdata: AdminappCreateData, ctrl=None) -> Adminapp:
        utility = self._utility
