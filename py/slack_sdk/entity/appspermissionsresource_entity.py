...
class AppspermissionsresourceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AppspermissionsresourceEntity(self._client, opts)
    ...
    def data_get(self) -> Appspermissionsresource:
    ...
    def match_get(self) -> Appspermissionsresource:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Appspermissionsresource]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Appspermissionsresource().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
