...
class ConversationslistEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationslistEntity(self._client, opts)
    ...
    def data_get(self) -> Conversationslist:
    ...
    def match_get(self) -> Conversationslist:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Conversationslist]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Conversationslist().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
