...
class AdminteamsownerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminteamsownerEntity(self._client, opts)
    ...
    def data_get(self) -> Adminteamsowner:
    ...
    def match_get(self) -> Adminteamsowner:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Adminteamsowner:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Adminteamsowner().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
