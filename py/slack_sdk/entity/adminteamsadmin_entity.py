...
class AdminteamsadminEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminteamsadminEntity(self._client, opts)
    ...
    def data_get(self) -> Adminteamsadmin:
    ...
    def match_get(self) -> Adminteamsadmin:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Adminteamsadmin:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Adminteamsadmin().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
