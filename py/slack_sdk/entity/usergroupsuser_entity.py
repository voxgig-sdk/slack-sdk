...
class UsergroupsuserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UsergroupsuserEntity(self._client, opts)
    ...
    def data_get(self) -> Usergroupsuser:
    ...
    def match_get(self) -> Usergroupsuser:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Usergroupsuser]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Usergroupsuser().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: UsergroupsuserCreateData, ctrl=None) -> Usergroupsuser:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
