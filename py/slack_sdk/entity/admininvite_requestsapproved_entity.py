...
class AdmininviteRequestsapprovedEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdmininviteRequestsapprovedEntity(self._client, opts)
    ...
    def data_get(self) -> AdmininviteRequestsapproved:
    ...
    def match_get(self) -> AdmininviteRequestsapproved:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AdmininviteRequestsapproved:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AdmininviteRequestsapproved().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
