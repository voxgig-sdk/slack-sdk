...
class AdmininviteRequestsdeniedEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdmininviteRequestsdeniedEntity(self._client, opts)
    ...
    def data_get(self) -> AdmininviteRequestsdenied:
    ...
    def match_get(self) -> AdmininviteRequestsdenied:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AdmininviteRequestsdenied:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AdmininviteRequestsdenied().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
