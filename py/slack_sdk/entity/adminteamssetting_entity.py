...
class AdminteamssettingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminteamssettingEntity(self._client, opts)
    ...
    def data_get(self) -> Adminteamssetting:
    ...
    def match_get(self) -> Adminteamssetting:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Adminteamssetting:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Adminteamssetting().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: AdminteamssettingCreateData, ctrl=None) -> Adminteamssetting:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
