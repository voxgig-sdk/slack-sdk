...
class UsergroupEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UsergroupEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Usergroup]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Usergroup().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: UsergroupCreateData, ctrl=None) -> Usergroup:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
