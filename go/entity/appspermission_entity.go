...
type AppspermissionEntity struct {
	name    string
...
func NewAppspermissionEntity(client *core.SlackSDK, entopts map[string]any) *AppspermissionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AppspermissionEntity) GetName() string { return e.name }
...
func (e *AppspermissionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AppspermissionEntity) Deleted() bool {
	return e.deleted
}


func (e *AppspermissionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAppspermissionEntity(e.client, opts)
}

func (e *AppspermissionEntity) Data(args ...any) any {
...
func (e *AppspermissionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Appspermission; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AppspermissionEntity) DataTyped(data ...Appspermission) Appspermission {
	if len(data) > 0 {
		return typedFrom[Appspermission](e.Data(asMap(data[0])))
	}
	return typedFrom[Appspermission](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Appspermission (all fields
// optional at the wire level).
func (e *AppspermissionEntity) MatchTyped(match ...Appspermission) Appspermission {
	if len(match) > 0 {
		return typedFrom[Appspermission](e.Match(asMap(match[0])))
	}
	return typedFrom[Appspermission](e.Match())
}
...
func (e *AppspermissionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AppspermissionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AppspermissionLoadMatch and returns an Appspermission. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AppspermissionEntity) LoadTyped(reqmatch AppspermissionLoadMatch, ctrl map[string]any) (Appspermission, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Appspermission{}, err
	}
	return typedFrom[Appspermission](res), nil
}



func (e *AppspermissionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AppspermissionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AppspermissionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AppspermissionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AppspermissionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
