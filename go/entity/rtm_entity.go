...
func NewRtmEntity(client *core.SlackSDK, entopts map[string]any) *RtmEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RtmEntity) GetName() string { return e.name }
...
func (e *RtmEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RtmEntity) Deleted() bool {
	return e.deleted
}


func (e *RtmEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRtmEntity(e.client, opts)
}

func (e *RtmEntity) Data(args ...any) any {
...
func (e *RtmEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rtm; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RtmEntity) DataTyped(data ...Rtm) Rtm {
	if len(data) > 0 {
		return typedFrom[Rtm](e.Data(asMap(data[0])))
	}
	return typedFrom[Rtm](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rtm (all fields
// optional at the wire level).
func (e *RtmEntity) MatchTyped(match ...Rtm) Rtm {
	if len(match) > 0 {
		return typedFrom[Rtm](e.Match(asMap(match[0])))
	}
	return typedFrom[Rtm](e.Match())
}
...
func (e *RtmEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RtmEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RtmLoadMatch and returns an Rtm. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RtmEntity) LoadTyped(reqmatch RtmLoadMatch, ctrl map[string]any) (Rtm, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Rtm{}, err
	}
	return typedFrom[Rtm](res), nil
}



func (e *RtmEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RtmEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RtmEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RtmEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RtmEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
