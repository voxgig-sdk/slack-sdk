...
type ConversationsinfoEntity struct {
	name    string
...
func NewConversationsinfoEntity(client *core.SlackSDK, entopts map[string]any) *ConversationsinfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConversationsinfoEntity) GetName() string { return e.name }
...
func (e *ConversationsinfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConversationsinfoEntity) Deleted() bool {
	return e.deleted
}


func (e *ConversationsinfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConversationsinfoEntity(e.client, opts)
}

func (e *ConversationsinfoEntity) Data(args ...any) any {
...
func (e *ConversationsinfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Conversationsinfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConversationsinfoEntity) DataTyped(data ...Conversationsinfo) Conversationsinfo {
	if len(data) > 0 {
		return typedFrom[Conversationsinfo](e.Data(asMap(data[0])))
	}
	return typedFrom[Conversationsinfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Conversationsinfo (all fields
// optional at the wire level).
func (e *ConversationsinfoEntity) MatchTyped(match ...Conversationsinfo) Conversationsinfo {
	if len(match) > 0 {
		return typedFrom[Conversationsinfo](e.Match(asMap(match[0])))
	}
	return typedFrom[Conversationsinfo](e.Match())
}
...
func (e *ConversationsinfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConversationsinfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConversationsinfoLoadMatch and returns an Conversationsinfo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ConversationsinfoEntity) LoadTyped(reqmatch ConversationsinfoLoadMatch, ctrl map[string]any) (Conversationsinfo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Conversationsinfo{}, err
	}
	return typedFrom[Conversationsinfo](res), nil
}



func (e *ConversationsinfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ConversationsinfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ConversationsinfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ConversationsinfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ConversationsinfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
