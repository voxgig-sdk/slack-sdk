...
type CallsparticipantEntity struct {
	name    string
...
func NewCallsparticipantEntity(client *core.SlackSDK, entopts map[string]any) *CallsparticipantEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CallsparticipantEntity) GetName() string { return e.name }
...
func (e *CallsparticipantEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CallsparticipantEntity) Deleted() bool {
	return e.deleted
}


func (e *CallsparticipantEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCallsparticipantEntity(e.client, opts)
}

func (e *CallsparticipantEntity) Data(args ...any) any {
...
func (e *CallsparticipantEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Callsparticipant; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CallsparticipantEntity) DataTyped(data ...Callsparticipant) Callsparticipant {
	if len(data) > 0 {
		return typedFrom[Callsparticipant](e.Data(asMap(data[0])))
	}
	return typedFrom[Callsparticipant](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Callsparticipant (all fields
// optional at the wire level).
func (e *CallsparticipantEntity) MatchTyped(match ...Callsparticipant) Callsparticipant {
	if len(match) > 0 {
		return typedFrom[Callsparticipant](e.Match(asMap(match[0])))
	}
	return typedFrom[Callsparticipant](e.Match())
}
...
func (e *CallsparticipantEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CallsparticipantEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CallsparticipantEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CallsparticipantEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CallsparticipantCreateData and returns an Callsparticipant. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CallsparticipantEntity) CreateTyped(reqdata CallsparticipantCreateData, ctrl map[string]any) (Callsparticipant, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Callsparticipant{}, err
	}
	return typedFrom[Callsparticipant](res), nil
}



func (e *CallsparticipantEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CallsparticipantEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CallsparticipantEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
