...
func NewAdminemojiEntity(client *core.SlackSDK, entopts map[string]any) *AdminemojiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminemojiEntity) GetName() string { return e.name }
...
func (e *AdminemojiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminemojiEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminemojiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminemojiEntity(e.client, opts)
}

func (e *AdminemojiEntity) Data(args ...any) any {
...
func (e *AdminemojiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Adminemoji; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminemojiEntity) DataTyped(data ...Adminemoji) Adminemoji {
	if len(data) > 0 {
		return typedFrom[Adminemoji](e.Data(asMap(data[0])))
	}
	return typedFrom[Adminemoji](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Adminemoji (all fields
// optional at the wire level).
func (e *AdminemojiEntity) MatchTyped(match ...Adminemoji) Adminemoji {
	if len(match) > 0 {
		return typedFrom[Adminemoji](e.Match(asMap(match[0])))
	}
	return typedFrom[Adminemoji](e.Match())
}
...
func (e *AdminemojiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminemojiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminemojiLoadMatch and returns an Adminemoji. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdminemojiEntity) LoadTyped(reqmatch AdminemojiLoadMatch, ctrl map[string]any) (Adminemoji, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Adminemoji{}, err
	}
	return typedFrom[Adminemoji](res), nil
}



func (e *AdminemojiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AdminemojiEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AdminemojiCreateData and returns an Adminemoji. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AdminemojiEntity) CreateTyped(reqdata AdminemojiCreateData, ctrl map[string]any) (Adminemoji, error) {
...
func (e *AdminemojiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdminemojiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminemojiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
