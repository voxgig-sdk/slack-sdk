...
type AdminteamsownerEntity struct {
	name    string
...
func NewAdminteamsownerEntity(client *core.SlackSDK, entopts map[string]any) *AdminteamsownerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminteamsownerEntity) GetName() string { return e.name }
...
func (e *AdminteamsownerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminteamsownerEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminteamsownerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminteamsownerEntity(e.client, opts)
}

func (e *AdminteamsownerEntity) Data(args ...any) any {
...
func (e *AdminteamsownerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Adminteamsowner; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminteamsownerEntity) DataTyped(data ...Adminteamsowner) Adminteamsowner {
	if len(data) > 0 {
		return typedFrom[Adminteamsowner](e.Data(asMap(data[0])))
	}
	return typedFrom[Adminteamsowner](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Adminteamsowner (all fields
// optional at the wire level).
func (e *AdminteamsownerEntity) MatchTyped(match ...Adminteamsowner) Adminteamsowner {
	if len(match) > 0 {
		return typedFrom[Adminteamsowner](e.Match(asMap(match[0])))
	}
	return typedFrom[Adminteamsowner](e.Match())
}
...
func (e *AdminteamsownerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminteamsownerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminteamsownerLoadMatch and returns an Adminteamsowner. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdminteamsownerEntity) LoadTyped(reqmatch AdminteamsownerLoadMatch, ctrl map[string]any) (Adminteamsowner, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Adminteamsowner{}, err
	}
	return typedFrom[Adminteamsowner](res), nil
}



func (e *AdminteamsownerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AdminteamsownerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdminteamsownerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdminteamsownerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminteamsownerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
