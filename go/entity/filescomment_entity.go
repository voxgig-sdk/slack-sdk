...
type FilescommentEntity struct {
	name    string
...
func NewFilescommentEntity(client *core.SlackSDK, entopts map[string]any) *FilescommentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FilescommentEntity) GetName() string { return e.name }
...
func (e *FilescommentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FilescommentEntity) Deleted() bool {
	return e.deleted
}


func (e *FilescommentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFilescommentEntity(e.client, opts)
}

func (e *FilescommentEntity) Data(args ...any) any {
...
func (e *FilescommentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Filescomment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FilescommentEntity) DataTyped(data ...Filescomment) Filescomment {
	if len(data) > 0 {
		return typedFrom[Filescomment](e.Data(asMap(data[0])))
	}
	return typedFrom[Filescomment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Filescomment (all fields
// optional at the wire level).
func (e *FilescommentEntity) MatchTyped(match ...Filescomment) Filescomment {
	if len(match) > 0 {
		return typedFrom[Filescomment](e.Match(asMap(match[0])))
	}
	return typedFrom[Filescomment](e.Match())
}
...
func (e *FilescommentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FilescommentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *FilescommentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *FilescommentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FilescommentCreateData and returns an Filescomment. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FilescommentEntity) CreateTyped(reqdata FilescommentCreateData, ctrl map[string]any) (Filescomment, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Filescomment{}, err
	}
	return typedFrom[Filescomment](res), nil
}



func (e *FilescommentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FilescommentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FilescommentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
