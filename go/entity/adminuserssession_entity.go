...
type AdminuserssessionEntity struct {
	name    string
...
func NewAdminuserssessionEntity(client *core.SlackSDK, entopts map[string]any) *AdminuserssessionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminuserssessionEntity) GetName() string { return e.name }
...
func (e *AdminuserssessionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminuserssessionEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminuserssessionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminuserssessionEntity(e.client, opts)
}

func (e *AdminuserssessionEntity) Data(args ...any) any {
...
func (e *AdminuserssessionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Adminuserssession; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminuserssessionEntity) DataTyped(data ...Adminuserssession) Adminuserssession {
	if len(data) > 0 {
		return typedFrom[Adminuserssession](e.Data(asMap(data[0])))
	}
	return typedFrom[Adminuserssession](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Adminuserssession (all fields
// optional at the wire level).
func (e *AdminuserssessionEntity) MatchTyped(match ...Adminuserssession) Adminuserssession {
	if len(match) > 0 {
		return typedFrom[Adminuserssession](e.Match(asMap(match[0])))
	}
	return typedFrom[Adminuserssession](e.Match())
}
...
func (e *AdminuserssessionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminuserssessionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AdminuserssessionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AdminuserssessionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminuserssessionCreateData and returns an Adminuserssession. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AdminuserssessionEntity) CreateTyped(reqdata AdminuserssessionCreateData, ctrl map[string]any) (Adminuserssession, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Adminuserssession{}, err
	}
	return typedFrom[Adminuserssession](res), nil
}



func (e *AdminuserssessionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdminuserssessionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminuserssessionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
