...
func NewMigrationEntity(client *core.SlackSDK, entopts map[string]any) *MigrationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MigrationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MigrationListMatch and returns []Migration. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MigrationEntity) ListTyped(reqmatch MigrationListMatch, ctrl map[string]any) ([]Migration, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Migration](res), nil
}



func (e *MigrationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
