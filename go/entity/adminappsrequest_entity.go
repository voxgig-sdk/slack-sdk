...
type AdminappsrequestEntity struct {
	name    string
...
func NewAdminappsrequestEntity(client *core.SlackSDK, entopts map[string]any) *AdminappsrequestEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminappsrequestEntity) GetName() string { return e.name }
...
func (e *AdminappsrequestEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminappsrequestEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminappsrequestEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminappsrequestEntity(e.client, opts)
}

func (e *AdminappsrequestEntity) Data(args ...any) any {
...
func (e *AdminappsrequestEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Adminappsrequest; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminappsrequestEntity) DataTyped(data ...Adminappsrequest) Adminappsrequest {
	if len(data) > 0 {
		return typedFrom[Adminappsrequest](e.Data(asMap(data[0])))
	}
	return typedFrom[Adminappsrequest](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Adminappsrequest (all fields
// optional at the wire level).
func (e *AdminappsrequestEntity) MatchTyped(match ...Adminappsrequest) Adminappsrequest {
	if len(match) > 0 {
		return typedFrom[Adminappsrequest](e.Match(asMap(match[0])))
	}
	return typedFrom[Adminappsrequest](e.Match())
}
...
func (e *AdminappsrequestEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminappsrequestEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminappsrequestLoadMatch and returns an Adminappsrequest. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdminappsrequestEntity) LoadTyped(reqmatch AdminappsrequestLoadMatch, ctrl map[string]any) (Adminappsrequest, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Adminappsrequest{}, err
	}
	return typedFrom[Adminappsrequest](res), nil
}



func (e *AdminappsrequestEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AdminappsrequestEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdminappsrequestEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdminappsrequestEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminappsrequestEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
