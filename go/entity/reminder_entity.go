...
func NewReminderEntity(client *core.SlackSDK, entopts map[string]any) *ReminderEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReminderEntity) GetName() string { return e.name }
...
func (e *ReminderEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReminderEntity) Deleted() bool {
	return e.deleted
}


func (e *ReminderEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReminderEntity(e.client, opts)
}

func (e *ReminderEntity) Data(args ...any) any {
...
func (e *ReminderEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Reminder; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReminderEntity) DataTyped(data ...Reminder) Reminder {
	if len(data) > 0 {
		return typedFrom[Reminder](e.Data(asMap(data[0])))
	}
	return typedFrom[Reminder](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Reminder (all fields
// optional at the wire level).
func (e *ReminderEntity) MatchTyped(match ...Reminder) Reminder {
	if len(match) > 0 {
		return typedFrom[Reminder](e.Match(asMap(match[0])))
	}
	return typedFrom[Reminder](e.Match())
}
...
func (e *ReminderEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReminderEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReminderLoadMatch and returns an Reminder. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReminderEntity) LoadTyped(reqmatch ReminderLoadMatch, ctrl map[string]any) (Reminder, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Reminder{}, err
	}
	return typedFrom[Reminder](res), nil
}




func (e *ReminderEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ReminderListMatch and returns []Reminder. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ReminderEntity) ListTyped(reqmatch ReminderListMatch, ctrl map[string]any) ([]Reminder, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Reminder](res), nil
}




func (e *ReminderEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ReminderCreateData and returns an Reminder. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ReminderEntity) CreateTyped(reqdata ReminderCreateData, ctrl map[string]any) (Reminder, error) {
...
func (e *ReminderEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReminderEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReminderEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
