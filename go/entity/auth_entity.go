...
func NewAuthEntity(client *core.SlackSDK, entopts map[string]any) *AuthEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AuthEntity) GetName() string { return e.name }
...
func (e *AuthEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AuthEntity) Deleted() bool {
	return e.deleted
}


func (e *AuthEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAuthEntity(e.client, opts)
}

func (e *AuthEntity) Data(args ...any) any {
...
func (e *AuthEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Auth; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AuthEntity) DataTyped(data ...Auth) Auth {
	if len(data) > 0 {
		return typedFrom[Auth](e.Data(asMap(data[0])))
	}
	return typedFrom[Auth](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Auth (all fields
// optional at the wire level).
func (e *AuthEntity) MatchTyped(match ...Auth) Auth {
	if len(match) > 0 {
		return typedFrom[Auth](e.Match(asMap(match[0])))
	}
	return typedFrom[Auth](e.Match())
}
...
func (e *AuthEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AuthEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AuthLoadMatch and returns an Auth. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AuthEntity) LoadTyped(reqmatch AuthLoadMatch, ctrl map[string]any) (Auth, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Auth{}, err
	}
	return typedFrom[Auth](res), nil
}



func (e *AuthEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AuthEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AuthEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AuthEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AuthEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
