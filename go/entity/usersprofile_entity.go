...
type UsersprofileEntity struct {
	name    string
...
func NewUsersprofileEntity(client *core.SlackSDK, entopts map[string]any) *UsersprofileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UsersprofileEntity) GetName() string { return e.name }
...
func (e *UsersprofileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UsersprofileEntity) Deleted() bool {
	return e.deleted
}


func (e *UsersprofileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUsersprofileEntity(e.client, opts)
}

func (e *UsersprofileEntity) Data(args ...any) any {
...
func (e *UsersprofileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Usersprofile; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UsersprofileEntity) DataTyped(data ...Usersprofile) Usersprofile {
	if len(data) > 0 {
		return typedFrom[Usersprofile](e.Data(asMap(data[0])))
	}
	return typedFrom[Usersprofile](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Usersprofile (all fields
// optional at the wire level).
func (e *UsersprofileEntity) MatchTyped(match ...Usersprofile) Usersprofile {
	if len(match) > 0 {
		return typedFrom[Usersprofile](e.Match(asMap(match[0])))
	}
	return typedFrom[Usersprofile](e.Match())
}
...
func (e *UsersprofileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UsersprofileEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UsersprofileLoadMatch and returns an Usersprofile. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UsersprofileEntity) LoadTyped(reqmatch UsersprofileLoadMatch, ctrl map[string]any) (Usersprofile, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Usersprofile{}, err
	}
	return typedFrom[Usersprofile](res), nil
}



func (e *UsersprofileEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UsersprofileEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// UsersprofileCreateData and returns an Usersprofile. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UsersprofileEntity) CreateTyped(reqdata UsersprofileCreateData, ctrl map[string]any) (Usersprofile, error) {
...
func (e *UsersprofileEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UsersprofileEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UsersprofileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
