...
func NewFilesremoteEntity(client *core.SlackSDK, entopts map[string]any) *FilesremoteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FilesremoteEntity) GetName() string { return e.name }
...
func (e *FilesremoteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FilesremoteEntity) Deleted() bool {
	return e.deleted
}


func (e *FilesremoteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFilesremoteEntity(e.client, opts)
}

func (e *FilesremoteEntity) Data(args ...any) any {
...
func (e *FilesremoteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Filesremote; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FilesremoteEntity) DataTyped(data ...Filesremote) Filesremote {
	if len(data) > 0 {
		return typedFrom[Filesremote](e.Data(asMap(data[0])))
	}
	return typedFrom[Filesremote](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Filesremote (all fields
// optional at the wire level).
func (e *FilesremoteEntity) MatchTyped(match ...Filesremote) Filesremote {
	if len(match) > 0 {
		return typedFrom[Filesremote](e.Match(asMap(match[0])))
	}
	return typedFrom[Filesremote](e.Match())
}
...
func (e *FilesremoteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FilesremoteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FilesremoteLoadMatch and returns an Filesremote. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FilesremoteEntity) LoadTyped(reqmatch FilesremoteLoadMatch, ctrl map[string]any) (Filesremote, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Filesremote{}, err
	}
	return typedFrom[Filesremote](res), nil
}



func (e *FilesremoteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *FilesremoteEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// FilesremoteCreateData and returns an Filesremote. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FilesremoteEntity) CreateTyped(reqdata FilesremoteCreateData, ctrl map[string]any) (Filesremote, error) {
...
func (e *FilesremoteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FilesremoteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FilesremoteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
