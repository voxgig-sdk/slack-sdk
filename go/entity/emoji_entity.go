...
func NewEmojiEntity(client *core.SlackSDK, entopts map[string]any) *EmojiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmojiEntity) GetName() string { return e.name }
...
func (e *EmojiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EmojiEntity) Deleted() bool {
	return e.deleted
}


func (e *EmojiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmojiEntity(e.client, opts)
}

func (e *EmojiEntity) Data(args ...any) any {
...
func (e *EmojiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Emoji; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EmojiEntity) DataTyped(data ...Emoji) Emoji {
	if len(data) > 0 {
		return typedFrom[Emoji](e.Data(asMap(data[0])))
	}
	return typedFrom[Emoji](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Emoji (all fields
// optional at the wire level).
func (e *EmojiEntity) MatchTyped(match ...Emoji) Emoji {
	if len(match) > 0 {
		return typedFrom[Emoji](e.Match(asMap(match[0])))
	}
	return typedFrom[Emoji](e.Match())
}
...
func (e *EmojiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmojiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EmojiLoadMatch and returns an Emoji. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EmojiEntity) LoadTyped(reqmatch EmojiLoadMatch, ctrl map[string]any) (Emoji, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Emoji{}, err
	}
	return typedFrom[Emoji](res), nil
}



func (e *EmojiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EmojiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EmojiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EmojiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EmojiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
