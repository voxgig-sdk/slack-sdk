...
func NewPinEntity(client *core.SlackSDK, entopts map[string]any) *PinEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PinEntity) GetName() string { return e.name }
...
func (e *PinEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PinEntity) Deleted() bool {
	return e.deleted
}


func (e *PinEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPinEntity(e.client, opts)
}

func (e *PinEntity) Data(args ...any) any {
...
func (e *PinEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PinEntity) DataTyped(data ...Pin) Pin {
	if len(data) > 0 {
		return typedFrom[Pin](e.Data(asMap(data[0])))
	}
	return typedFrom[Pin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pin (all fields
// optional at the wire level).
func (e *PinEntity) MatchTyped(match ...Pin) Pin {
	if len(match) > 0 {
		return typedFrom[Pin](e.Match(asMap(match[0])))
	}
	return typedFrom[Pin](e.Match())
}
...
func (e *PinEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PinEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PinLoadMatch and returns an Pin. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PinEntity) LoadTyped(reqmatch PinLoadMatch, ctrl map[string]any) (Pin, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Pin{}, err
	}
	return typedFrom[Pin](res), nil
}



func (e *PinEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PinEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// PinCreateData and returns an Pin. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PinEntity) CreateTyped(reqdata PinCreateData, ctrl map[string]any) (Pin, error) {
...
func (e *PinEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PinEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PinEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
