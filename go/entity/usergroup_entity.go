...
func NewUsergroupEntity(client *core.SlackSDK, entopts map[string]any) *UsergroupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UsergroupEntity) GetName() string { return e.name }
...
func (e *UsergroupEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UsergroupEntity) Deleted() bool {
	return e.deleted
}


func (e *UsergroupEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUsergroupEntity(e.client, opts)
}

func (e *UsergroupEntity) Data(args ...any) any {
...
func (e *UsergroupEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Usergroup; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UsergroupEntity) DataTyped(data ...Usergroup) Usergroup {
	if len(data) > 0 {
		return typedFrom[Usergroup](e.Data(asMap(data[0])))
	}
	return typedFrom[Usergroup](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Usergroup (all fields
// optional at the wire level).
func (e *UsergroupEntity) MatchTyped(match ...Usergroup) Usergroup {
	if len(match) > 0 {
		return typedFrom[Usergroup](e.Match(asMap(match[0])))
	}
	return typedFrom[Usergroup](e.Match())
}
...
func (e *UsergroupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UsergroupEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *UsergroupEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UsergroupListMatch and returns []Usergroup. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *UsergroupEntity) ListTyped(reqmatch UsergroupListMatch, ctrl map[string]any) ([]Usergroup, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Usergroup](res), nil
}




func (e *UsergroupEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// UsergroupCreateData and returns an Usergroup. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UsergroupEntity) CreateTyped(reqdata UsergroupCreateData, ctrl map[string]any) (Usergroup, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Usergroup{}, err
	}
	return typedFrom[Usergroup](res), nil
}



func (e *UsergroupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UsergroupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UsergroupEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
