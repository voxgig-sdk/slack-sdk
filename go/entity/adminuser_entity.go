...
func NewAdminuserEntity(client *core.SlackSDK, entopts map[string]any) *AdminuserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminuserEntity) GetName() string { return e.name }
...
func (e *AdminuserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminuserEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminuserEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminuserEntity(e.client, opts)
}

func (e *AdminuserEntity) Data(args ...any) any {
...
func (e *AdminuserEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Adminuser; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminuserEntity) DataTyped(data ...Adminuser) Adminuser {
	if len(data) > 0 {
		return typedFrom[Adminuser](e.Data(asMap(data[0])))
	}
	return typedFrom[Adminuser](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Adminuser (all fields
// optional at the wire level).
func (e *AdminuserEntity) MatchTyped(match ...Adminuser) Adminuser {
	if len(match) > 0 {
		return typedFrom[Adminuser](e.Match(asMap(match[0])))
	}
	return typedFrom[Adminuser](e.Match())
}
...
func (e *AdminuserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminuserEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminuserLoadMatch and returns an Adminuser. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdminuserEntity) LoadTyped(reqmatch AdminuserLoadMatch, ctrl map[string]any) (Adminuser, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Adminuser{}, err
	}
	return typedFrom[Adminuser](res), nil
}



func (e *AdminuserEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AdminuserEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AdminuserCreateData and returns an Adminuser. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AdminuserEntity) CreateTyped(reqdata AdminuserCreateData, ctrl map[string]any) (Adminuser, error) {
...
func (e *AdminuserEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdminuserEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminuserEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
