...
func NewReactionEntity(client *core.SlackSDK, entopts map[string]any) *ReactionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReactionEntity) GetName() string { return e.name }
...
func (e *ReactionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReactionEntity) Deleted() bool {
	return e.deleted
}


func (e *ReactionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReactionEntity(e.client, opts)
}

func (e *ReactionEntity) Data(args ...any) any {
...
func (e *ReactionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Reaction; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReactionEntity) DataTyped(data ...Reaction) Reaction {
	if len(data) > 0 {
		return typedFrom[Reaction](e.Data(asMap(data[0])))
	}
	return typedFrom[Reaction](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Reaction (all fields
// optional at the wire level).
func (e *ReactionEntity) MatchTyped(match ...Reaction) Reaction {
	if len(match) > 0 {
		return typedFrom[Reaction](e.Match(asMap(match[0])))
	}
	return typedFrom[Reaction](e.Match())
}
...
func (e *ReactionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReactionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReactionLoadMatch and returns an Reaction. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReactionEntity) LoadTyped(reqmatch ReactionLoadMatch, ctrl map[string]any) (Reaction, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Reaction{}, err
	}
	return typedFrom[Reaction](res), nil
}




func (e *ReactionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ReactionListMatch and returns []Reaction. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ReactionEntity) ListTyped(reqmatch ReactionListMatch, ctrl map[string]any) ([]Reaction, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Reaction](res), nil
}




func (e *ReactionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ReactionCreateData and returns an Reaction. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ReactionEntity) CreateTyped(reqdata ReactionCreateData, ctrl map[string]any) (Reaction, error) {
...
func (e *ReactionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReactionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReactionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
