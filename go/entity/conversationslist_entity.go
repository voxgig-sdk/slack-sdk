...
type ConversationslistEntity struct {
	name    string
...
func NewConversationslistEntity(client *core.SlackSDK, entopts map[string]any) *ConversationslistEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConversationslistEntity) GetName() string { return e.name }
...
func (e *ConversationslistEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConversationslistEntity) Deleted() bool {
	return e.deleted
}


func (e *ConversationslistEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConversationslistEntity(e.client, opts)
}

func (e *ConversationslistEntity) Data(args ...any) any {
...
func (e *ConversationslistEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Conversationslist; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConversationslistEntity) DataTyped(data ...Conversationslist) Conversationslist {
	if len(data) > 0 {
		return typedFrom[Conversationslist](e.Data(asMap(data[0])))
	}
	return typedFrom[Conversationslist](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Conversationslist (all fields
// optional at the wire level).
func (e *ConversationslistEntity) MatchTyped(match ...Conversationslist) Conversationslist {
	if len(match) > 0 {
		return typedFrom[Conversationslist](e.Match(asMap(match[0])))
	}
	return typedFrom[Conversationslist](e.Match())
}
...
func (e *ConversationslistEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConversationslistEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ConversationslistEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConversationslistListMatch and returns []Conversationslist. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ConversationslistEntity) ListTyped(reqmatch ConversationslistListMatch, ctrl map[string]any) ([]Conversationslist, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Conversationslist](res), nil
}



func (e *ConversationslistEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ConversationslistEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ConversationslistEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ConversationslistEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
