...
func NewOauthv2Entity(client *core.SlackSDK, entopts map[string]any) *Oauthv2Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Oauthv2Entity) GetName() string { return e.name }
...
func (e *Oauthv2Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Oauthv2Entity) Deleted() bool {
	return e.deleted
}


func (e *Oauthv2Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOauthv2Entity(e.client, opts)
}

func (e *Oauthv2Entity) Data(args ...any) any {
...
func (e *Oauthv2Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Oauthv2; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Oauthv2Entity) DataTyped(data ...Oauthv2) Oauthv2 {
	if len(data) > 0 {
		return typedFrom[Oauthv2](e.Data(asMap(data[0])))
	}
	return typedFrom[Oauthv2](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Oauthv2 (all fields
// optional at the wire level).
func (e *Oauthv2Entity) MatchTyped(match ...Oauthv2) Oauthv2 {
	if len(match) > 0 {
		return typedFrom[Oauthv2](e.Match(asMap(match[0])))
	}
	return typedFrom[Oauthv2](e.Match())
}
...
func (e *Oauthv2Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Oauthv2Entity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// Oauthv2LoadMatch and returns an Oauthv2. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *Oauthv2Entity) LoadTyped(reqmatch Oauthv2LoadMatch, ctrl map[string]any) (Oauthv2, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Oauthv2{}, err
	}
	return typedFrom[Oauthv2](res), nil
}



func (e *Oauthv2Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Oauthv2Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Oauthv2Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Oauthv2Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Oauthv2Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
