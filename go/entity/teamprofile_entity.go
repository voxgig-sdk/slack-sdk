...
func NewTeamprofileEntity(client *core.SlackSDK, entopts map[string]any) *TeamprofileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TeamprofileEntity) GetName() string { return e.name }
...
func (e *TeamprofileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TeamprofileEntity) Deleted() bool {
	return e.deleted
}


func (e *TeamprofileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTeamprofileEntity(e.client, opts)
}

func (e *TeamprofileEntity) Data(args ...any) any {
...
func (e *TeamprofileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Teamprofile; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TeamprofileEntity) DataTyped(data ...Teamprofile) Teamprofile {
	if len(data) > 0 {
		return typedFrom[Teamprofile](e.Data(asMap(data[0])))
	}
	return typedFrom[Teamprofile](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Teamprofile (all fields
// optional at the wire level).
func (e *TeamprofileEntity) MatchTyped(match ...Teamprofile) Teamprofile {
	if len(match) > 0 {
		return typedFrom[Teamprofile](e.Match(asMap(match[0])))
	}
	return typedFrom[Teamprofile](e.Match())
}
...
func (e *TeamprofileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TeamprofileEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TeamprofileLoadMatch and returns an Teamprofile. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TeamprofileEntity) LoadTyped(reqmatch TeamprofileLoadMatch, ctrl map[string]any) (Teamprofile, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Teamprofile{}, err
	}
	return typedFrom[Teamprofile](res), nil
}



func (e *TeamprofileEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TeamprofileEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TeamprofileEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TeamprofileEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TeamprofileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
