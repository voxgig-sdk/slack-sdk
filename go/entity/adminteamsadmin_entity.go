...
type AdminteamsadminEntity struct {
	name    string
...
func NewAdminteamsadminEntity(client *core.SlackSDK, entopts map[string]any) *AdminteamsadminEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminteamsadminEntity) GetName() string { return e.name }
...
func (e *AdminteamsadminEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminteamsadminEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminteamsadminEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminteamsadminEntity(e.client, opts)
}

func (e *AdminteamsadminEntity) Data(args ...any) any {
...
func (e *AdminteamsadminEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Adminteamsadmin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminteamsadminEntity) DataTyped(data ...Adminteamsadmin) Adminteamsadmin {
	if len(data) > 0 {
		return typedFrom[Adminteamsadmin](e.Data(asMap(data[0])))
	}
	return typedFrom[Adminteamsadmin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Adminteamsadmin (all fields
// optional at the wire level).
func (e *AdminteamsadminEntity) MatchTyped(match ...Adminteamsadmin) Adminteamsadmin {
	if len(match) > 0 {
		return typedFrom[Adminteamsadmin](e.Match(asMap(match[0])))
	}
	return typedFrom[Adminteamsadmin](e.Match())
}
...
func (e *AdminteamsadminEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminteamsadminEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminteamsadminLoadMatch and returns an Adminteamsadmin. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdminteamsadminEntity) LoadTyped(reqmatch AdminteamsadminLoadMatch, ctrl map[string]any) (Adminteamsadmin, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Adminteamsadmin{}, err
	}
	return typedFrom[Adminteamsadmin](res), nil
}



func (e *AdminteamsadminEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AdminteamsadminEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdminteamsadminEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdminteamsadminEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminteamsadminEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
