...
func NewAdminteamEntity(client *core.SlackSDK, entopts map[string]any) *AdminteamEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminteamEntity) GetName() string { return e.name }
...
func (e *AdminteamEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminteamEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminteamEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminteamEntity(e.client, opts)
}

func (e *AdminteamEntity) Data(args ...any) any {
...
func (e *AdminteamEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Adminteam; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminteamEntity) DataTyped(data ...Adminteam) Adminteam {
	if len(data) > 0 {
		return typedFrom[Adminteam](e.Data(asMap(data[0])))
	}
	return typedFrom[Adminteam](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Adminteam (all fields
// optional at the wire level).
func (e *AdminteamEntity) MatchTyped(match ...Adminteam) Adminteam {
	if len(match) > 0 {
		return typedFrom[Adminteam](e.Match(asMap(match[0])))
	}
	return typedFrom[Adminteam](e.Match())
}
...
func (e *AdminteamEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminteamEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminteamLoadMatch and returns an Adminteam. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdminteamEntity) LoadTyped(reqmatch AdminteamLoadMatch, ctrl map[string]any) (Adminteam, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Adminteam{}, err
	}
	return typedFrom[Adminteam](res), nil
}



func (e *AdminteamEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AdminteamEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AdminteamCreateData and returns an Adminteam. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AdminteamEntity) CreateTyped(reqdata AdminteamCreateData, ctrl map[string]any) (Adminteam, error) {
...
func (e *AdminteamEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdminteamEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminteamEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
