...
func NewAdminappEntity(client *core.SlackSDK, entopts map[string]any) *AdminappEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminappEntity) GetName() string { return e.name }
...
func (e *AdminappEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminappEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminappEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminappEntity(e.client, opts)
}

func (e *AdminappEntity) Data(args ...any) any {
...
func (e *AdminappEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Adminapp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminappEntity) DataTyped(data ...Adminapp) Adminapp {
	if len(data) > 0 {
		return typedFrom[Adminapp](e.Data(asMap(data[0])))
	}
	return typedFrom[Adminapp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Adminapp (all fields
// optional at the wire level).
func (e *AdminappEntity) MatchTyped(match ...Adminapp) Adminapp {
	if len(match) > 0 {
		return typedFrom[Adminapp](e.Match(asMap(match[0])))
	}
	return typedFrom[Adminapp](e.Match())
}
...
func (e *AdminappEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminappEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AdminappEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AdminappEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminappCreateData and returns an Adminapp. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AdminappEntity) CreateTyped(reqdata AdminappCreateData, ctrl map[string]any) (Adminapp, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Adminapp{}, err
	}
	return typedFrom[Adminapp](res), nil
}



func (e *AdminappEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdminappEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminappEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
