...
func NewChatEntity(client *core.SlackSDK, entopts map[string]any) *ChatEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ChatEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ChatCreateData and returns an Chat. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ChatEntity) CreateTyped(reqdata ChatCreateData, ctrl map[string]any) (Chat, error) {
