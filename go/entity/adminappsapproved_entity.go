...
type AdminappsapprovedEntity struct {
	name    string
...
func NewAdminappsapprovedEntity(client *core.SlackSDK, entopts map[string]any) *AdminappsapprovedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminappsapprovedEntity) GetName() string { return e.name }
...
func (e *AdminappsapprovedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminappsapprovedEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminappsapprovedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminappsapprovedEntity(e.client, opts)
}

func (e *AdminappsapprovedEntity) Data(args ...any) any {
...
func (e *AdminappsapprovedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Adminappsapproved; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminappsapprovedEntity) DataTyped(data ...Adminappsapproved) Adminappsapproved {
	if len(data) > 0 {
		return typedFrom[Adminappsapproved](e.Data(asMap(data[0])))
	}
	return typedFrom[Adminappsapproved](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Adminappsapproved (all fields
// optional at the wire level).
func (e *AdminappsapprovedEntity) MatchTyped(match ...Adminappsapproved) Adminappsapproved {
	if len(match) > 0 {
		return typedFrom[Adminappsapproved](e.Match(asMap(match[0])))
	}
	return typedFrom[Adminappsapproved](e.Match())
}
...
func (e *AdminappsapprovedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminappsapprovedEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminappsapprovedLoadMatch and returns an Adminappsapproved. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdminappsapprovedEntity) LoadTyped(reqmatch AdminappsapprovedLoadMatch, ctrl map[string]any) (Adminappsapproved, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Adminappsapproved{}, err
	}
	return typedFrom[Adminappsapproved](res), nil
}



func (e *AdminappsapprovedEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AdminappsapprovedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdminappsapprovedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdminappsapprovedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminappsapprovedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
