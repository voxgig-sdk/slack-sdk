...
func NewStarEntity(client *core.SlackSDK, entopts map[string]any) *StarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StarEntity) GetName() string { return e.name }
...
func (e *StarEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StarEntity) Deleted() bool {
	return e.deleted
}


func (e *StarEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStarEntity(e.client, opts)
}

func (e *StarEntity) Data(args ...any) any {
...
func (e *StarEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Star; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StarEntity) DataTyped(data ...Star) Star {
	if len(data) > 0 {
		return typedFrom[Star](e.Data(asMap(data[0])))
	}
	return typedFrom[Star](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Star (all fields
// optional at the wire level).
func (e *StarEntity) MatchTyped(match ...Star) Star {
	if len(match) > 0 {
		return typedFrom[Star](e.Match(asMap(match[0])))
	}
	return typedFrom[Star](e.Match())
}
...
func (e *StarEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StarEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *StarEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StarListMatch and returns []Star. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StarEntity) ListTyped(reqmatch StarListMatch, ctrl map[string]any) ([]Star, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Star](res), nil
}




func (e *StarEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// StarCreateData and returns an Star. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *StarEntity) CreateTyped(reqdata StarCreateData, ctrl map[string]any) (Star, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Star{}, err
	}
	return typedFrom[Star](res), nil
}



func (e *StarEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StarEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StarEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
