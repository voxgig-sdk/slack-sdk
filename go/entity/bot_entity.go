...
func NewBotEntity(client *core.SlackSDK, entopts map[string]any) *BotEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BotEntity) GetName() string { return e.name }
...
func (e *BotEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BotEntity) Deleted() bool {
	return e.deleted
}


func (e *BotEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBotEntity(e.client, opts)
}

func (e *BotEntity) Data(args ...any) any {
...
func (e *BotEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Bot; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BotEntity) DataTyped(data ...Bot) Bot {
	if len(data) > 0 {
		return typedFrom[Bot](e.Data(asMap(data[0])))
	}
	return typedFrom[Bot](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Bot (all fields
// optional at the wire level).
func (e *BotEntity) MatchTyped(match ...Bot) Bot {
	if len(match) > 0 {
		return typedFrom[Bot](e.Match(asMap(match[0])))
	}
	return typedFrom[Bot](e.Match())
}
...
func (e *BotEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BotEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BotLoadMatch and returns an Bot. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BotEntity) LoadTyped(reqmatch BotLoadMatch, ctrl map[string]any) (Bot, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Bot{}, err
	}
	return typedFrom[Bot](res), nil
}



func (e *BotEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BotEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BotEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BotEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BotEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
