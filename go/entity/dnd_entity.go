...
func NewDndEntity(client *core.SlackSDK, entopts map[string]any) *DndEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DndEntity) GetName() string { return e.name }
...
func (e *DndEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DndEntity) Deleted() bool {
	return e.deleted
}


func (e *DndEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDndEntity(e.client, opts)
}

func (e *DndEntity) Data(args ...any) any {
...
func (e *DndEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dnd; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DndEntity) DataTyped(data ...Dnd) Dnd {
	if len(data) > 0 {
		return typedFrom[Dnd](e.Data(asMap(data[0])))
	}
	return typedFrom[Dnd](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dnd (all fields
// optional at the wire level).
func (e *DndEntity) MatchTyped(match ...Dnd) Dnd {
	if len(match) > 0 {
		return typedFrom[Dnd](e.Match(asMap(match[0])))
	}
	return typedFrom[Dnd](e.Match())
}
...
func (e *DndEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DndEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DndLoadMatch and returns an Dnd. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DndEntity) LoadTyped(reqmatch DndLoadMatch, ctrl map[string]any) (Dnd, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Dnd{}, err
	}
	return typedFrom[Dnd](res), nil
}



func (e *DndEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DndEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DndCreateData and returns an Dnd. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DndEntity) CreateTyped(reqdata DndCreateData, ctrl map[string]any) (Dnd, error) {
...
func (e *DndEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DndEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DndEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
