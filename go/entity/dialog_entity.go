...
func NewDialogEntity(client *core.SlackSDK, entopts map[string]any) *DialogEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DialogEntity) GetName() string { return e.name }
...
func (e *DialogEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DialogEntity) Deleted() bool {
	return e.deleted
}


func (e *DialogEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDialogEntity(e.client, opts)
}

func (e *DialogEntity) Data(args ...any) any {
...
func (e *DialogEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dialog; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DialogEntity) DataTyped(data ...Dialog) Dialog {
	if len(data) > 0 {
		return typedFrom[Dialog](e.Data(asMap(data[0])))
	}
	return typedFrom[Dialog](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dialog (all fields
// optional at the wire level).
func (e *DialogEntity) MatchTyped(match ...Dialog) Dialog {
	if len(match) > 0 {
		return typedFrom[Dialog](e.Match(asMap(match[0])))
	}
	return typedFrom[Dialog](e.Match())
}
...
func (e *DialogEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DialogEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DialogLoadMatch and returns an Dialog. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DialogEntity) LoadTyped(reqmatch DialogLoadMatch, ctrl map[string]any) (Dialog, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Dialog{}, err
	}
	return typedFrom[Dialog](res), nil
}



func (e *DialogEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DialogEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DialogEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DialogEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DialogEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
