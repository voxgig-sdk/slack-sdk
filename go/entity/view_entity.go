...
func NewViewEntity(client *core.SlackSDK, entopts map[string]any) *ViewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ViewEntity) GetName() string { return e.name }
...
func (e *ViewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ViewEntity) Deleted() bool {
	return e.deleted
}


func (e *ViewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewViewEntity(e.client, opts)
}

func (e *ViewEntity) Data(args ...any) any {
...
func (e *ViewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an View; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ViewEntity) DataTyped(data ...View) View {
	if len(data) > 0 {
		return typedFrom[View](e.Data(asMap(data[0])))
	}
	return typedFrom[View](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through View (all fields
// optional at the wire level).
func (e *ViewEntity) MatchTyped(match ...View) View {
	if len(match) > 0 {
		return typedFrom[View](e.Match(asMap(match[0])))
	}
	return typedFrom[View](e.Match())
}
...
func (e *ViewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ViewEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ViewLoadMatch and returns an View. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ViewEntity) LoadTyped(reqmatch ViewLoadMatch, ctrl map[string]any) (View, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return View{}, err
	}
	return typedFrom[View](res), nil
}



func (e *ViewEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ViewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ViewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ViewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ViewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
