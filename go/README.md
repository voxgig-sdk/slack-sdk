...
```go
conversationsinfo, err := client.Conversationsinfo(nil).Load(map[string]any{"id": "conversationsinfo_id"}, nil)
if err != nil {
    panic(err)
}
...
conversationsinfo.Load(map[string]any{"id": "example_id"}, nil)
