...
func TestChatEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set SLACK_TEST_CHAT_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func chatBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("SLACK_TEST_CHAT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["SLACK_TEST_CHAT_ENTID"])
