...
const testSeed = `map[string]any{"entity": map[string]any{"conversationsinfo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversationslist": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
