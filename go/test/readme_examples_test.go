...
const testSeed = `map[string]any{"entity": map[string]any{"adminapp": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminappsapproved": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminappsrequest": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminappsrestricted": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminconversation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminconversationsekm": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminconversationsrestrict_access": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminemoji": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "admininvite_request": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "admininvite_requestsapproved": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "admininvite_requestsdenied": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminteam": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminteamsadmin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminteamsowner": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminteamssetting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminuser": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminusergroup": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adminuserssession": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "api": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "app": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "appseventauthorization": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "appspermission": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "appspermissionsresource": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "appspermissionsscope": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "appspermissionsuser": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "auth": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "bot": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "call": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "callsparticipant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "chat": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "chatscheduled_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dialog": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dnd": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "emoji": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "file": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "filescomment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "filesremote": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "migration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "oauth": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "oauthv2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reminder": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rtm": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "star": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "team": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "teamprofile": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "usergroup": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "usergroupsuser": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "usersprofile": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "workflow": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
