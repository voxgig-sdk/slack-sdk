...
// Slack SDK Conversationslist entity
...
class ConversationslistEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ConversationslistEntity($this->_client, $opts);
    }

    /**
     * @param Conversationslist|array $args Conversationslist data (assoc-array) to store.
     */
    ...
    /**
     * @return Conversationslist|array The current Conversationslist data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Conversationslist fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Conversationslist fields).
     */
    ...
    /**
     * List Conversationslist items matching the given filter.
     *
     * @param ConversationslistListMatch|array|null $reqmatch Match filter (any subset
     *   of Conversationslist fields) as an assoc-array; ConversationslistListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Conversationslist[]|array A list of Conversationslist items as assoc-arrays at
