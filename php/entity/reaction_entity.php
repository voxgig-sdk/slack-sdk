...
class ReactionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReactionEntity($this->_client, $opts);
    }

    /**
     * @param Reaction|array $args Reaction data (assoc-array) to store.
     */
    ...
    /**
     * @return Reaction|array The current Reaction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Reaction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Reaction fields).
     */
     ...
     *
     * @param ReactionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ReactionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Reaction|array The loaded Reaction as an assoc-array at the
    ...
    /**
     * List Reaction items matching the given filter.
     *
     * @param ReactionListMatch|array|null $reqmatch Match filter (any subset
     *   of Reaction fields) as an assoc-array; ReactionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Reaction[]|array A list of Reaction items as assoc-arrays at
     ...
     *
     * @param ReactionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReactionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Reaction|array The created Reaction as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
