...
class DialogEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DialogEntity($this->_client, $opts);
    }

    /**
     * @param Dialog|array $args Dialog data (assoc-array) to store.
     */
    ...
    /**
     * @return Dialog|array The current Dialog data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dialog fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dialog fields).
     */
    ...
    /**
     * Load a single Dialog.
     *
     * @param DialogLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DialogLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dialog|array The loaded Dialog as an assoc-array at the
