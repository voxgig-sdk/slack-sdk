...
class AdminemojiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminemojiEntity($this->_client, $opts);
    }

    /**
     * @param Adminemoji|array $args Adminemoji data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminemoji|array The current Adminemoji data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminemoji fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminemoji fields).
     */
    ...
    /**
     * Load a single Adminemoji.
     *
     * @param AdminemojiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminemojiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminemoji|array The loaded Adminemoji as an assoc-array at the
    ...
    /**
     * Create a new Adminemoji.
     *
     * @param AdminemojiCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AdminemojiCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminemoji|array The created Adminemoji as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
