...
// Slack SDK Adminteamsowner entity
...
class AdminteamsownerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminteamsownerEntity($this->_client, $opts);
    }

    /**
     * @param Adminteamsowner|array $args Adminteamsowner data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminteamsowner|array The current Adminteamsowner data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminteamsowner fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminteamsowner fields).
     */
    ...
    /**
     * Load a single Adminteamsowner.
     *
     * @param AdminteamsownerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminteamsownerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminteamsowner|array The loaded Adminteamsowner as an assoc-array at the
