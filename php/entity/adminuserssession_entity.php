...
// Slack SDK Adminuserssession entity
...
class AdminuserssessionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminuserssessionEntity($this->_client, $opts);
    }

    /**
     * @param Adminuserssession|array $args Adminuserssession data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminuserssession|array The current Adminuserssession data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminuserssession fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminuserssession fields).
     */
    ...
    /**
     * Create a new Adminuserssession.
     *
     * @param AdminuserssessionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AdminuserssessionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminuserssession|array The created Adminuserssession as an assoc-array at the
