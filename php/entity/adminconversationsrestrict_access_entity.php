...
// Slack SDK AdminconversationsrestrictAccess entity
...
class AdminconversationsrestrictAccessEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "adminconversationsrestrict_access";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AdminconversationsrestrictAccessEntity($this->_client, $opts);
    }

    /**
     * @param AdminconversationsrestrictAccess|array $args AdminconversationsrestrictAccess data (assoc-array) to store.
     */
    ...
    /**
     * @return AdminconversationsrestrictAccess|array The current AdminconversationsrestrictAccess data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AdminconversationsrestrictAccess fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AdminconversationsrestrictAccess fields).
     */
    ...
    /**
     * Load a single AdminconversationsrestrictAccess.
     *
     * @param AdminconversationsrestrictAccessLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminconversationsrestrictAccessLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AdminconversationsrestrictAccess|array The loaded AdminconversationsrestrictAccess as an assoc-array at the
    ...
    /**
     * Create a new AdminconversationsrestrictAccess.
     *
     * @param AdminconversationsrestrictAccessCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AdminconversationsrestrictAccessCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AdminconversationsrestrictAccess|array The created AdminconversationsrestrictAccess as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
