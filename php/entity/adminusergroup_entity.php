...
// Slack SDK Adminusergroup entity
...
class AdminusergroupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminusergroupEntity($this->_client, $opts);
    }

    /**
     * @param Adminusergroup|array $args Adminusergroup data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminusergroup|array The current Adminusergroup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminusergroup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminusergroup fields).
     */
    ...
    /**
     * Load a single Adminusergroup.
     *
     * @param AdminusergroupLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminusergroupLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminusergroup|array The loaded Adminusergroup as an assoc-array at the
    ...
    /**
     * Create a new Adminusergroup.
     *
     * @param AdminusergroupCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AdminusergroupCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminusergroup|array The created Adminusergroup as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
