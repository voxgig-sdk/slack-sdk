...
class StarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StarEntity($this->_client, $opts);
    }

    /**
     * @param Star|array $args Star data (assoc-array) to store.
     */
    ...
    /**
     * @return Star|array The current Star data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Star fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Star fields).
     */
    ...
    /**
     * List Star items matching the given filter.
     *
     * @param StarListMatch|array|null $reqmatch Match filter (any subset
     *   of Star fields) as an assoc-array; StarListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Star[]|array A list of Star items as assoc-arrays at
     ...
     * Create a new Star.
     *
     * @param StarCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StarCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Star|array The created Star as an assoc-array at the
