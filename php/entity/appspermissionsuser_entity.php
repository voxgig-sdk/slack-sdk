...
// Slack SDK Appspermissionsuser entity
...
class AppspermissionsuserEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "appspermissionsuser";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AppspermissionsuserEntity($this->_client, $opts);
    }

    /**
     * @param Appspermissionsuser|array $args Appspermissionsuser data (assoc-array) to store.
     */
    ...
    /**
     * @return Appspermissionsuser|array The current Appspermissionsuser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Appspermissionsuser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Appspermissionsuser fields).
     */
    ...
    /**
     * Load a single Appspermissionsuser.
     *
     * @param AppspermissionsuserLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AppspermissionsuserLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Appspermissionsuser|array The loaded Appspermissionsuser as an assoc-array at the
