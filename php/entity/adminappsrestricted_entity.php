...
// Slack SDK Adminappsrestricted entity
...
class AdminappsrestrictedEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "adminappsrestricted";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AdminappsrestrictedEntity($this->_client, $opts);
    }

    /**
     * @param Adminappsrestricted|array $args Adminappsrestricted data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminappsrestricted|array The current Adminappsrestricted data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminappsrestricted fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminappsrestricted fields).
     */
    ...
    /**
     * Load a single Adminappsrestricted.
     *
     * @param AdminappsrestrictedLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminappsrestrictedLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminappsrestricted|array The loaded Adminappsrestricted as an assoc-array at the
