...
class DndEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DndEntity($this->_client, $opts);
    }

    /**
     * @param Dnd|array $args Dnd data (assoc-array) to store.
     */
    ...
    /**
     * @return Dnd|array The current Dnd data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dnd fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dnd fields).
     */
     ...
     * Load a single Dnd.
     *
     * @param DndLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DndLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dnd|array The loaded Dnd as an assoc-array at the
     ...
     * Create a new Dnd.
     *
     * @param DndCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DndCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dnd|array The created Dnd as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
