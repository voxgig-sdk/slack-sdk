...
class UsersprofileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UsersprofileEntity($this->_client, $opts);
    }

    /**
     * @param Usersprofile|array $args Usersprofile data (assoc-array) to store.
     */
    ...
    /**
     * @return Usersprofile|array The current Usersprofile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Usersprofile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Usersprofile fields).
     */
    ...
    /**
     * Load a single Usersprofile.
     *
     * @param UsersprofileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UsersprofileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Usersprofile|array The loaded Usersprofile as an assoc-array at the
    ...
    /**
     * Create a new Usersprofile.
     *
     * @param UsersprofileCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UsersprofileCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Usersprofile|array The created Usersprofile as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
