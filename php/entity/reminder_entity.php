...
class ReminderEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReminderEntity($this->_client, $opts);
    }

    /**
     * @param Reminder|array $args Reminder data (assoc-array) to store.
     */
    ...
    /**
     * @return Reminder|array The current Reminder data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Reminder fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Reminder fields).
     */
    ...
    /**
     * Load a single Reminder.
     *
     * @param ReminderLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ReminderLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Reminder|array The loaded Reminder as an assoc-array at the
    ...
    /**
     * List Reminder items matching the given filter.
     *
     * @param ReminderListMatch|array|null $reqmatch Match filter (any subset
     *   of Reminder fields) as an assoc-array; ReminderListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Reminder[]|array A list of Reminder items as assoc-arrays at
     ...
     *
     * @param ReminderCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReminderCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Reminder|array The created Reminder as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
