...
class RtmEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RtmEntity($this->_client, $opts);
    }

    /**
     * @param Rtm|array $args Rtm data (assoc-array) to store.
     */
    ...
    /**
     * @return Rtm|array The current Rtm data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Rtm fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Rtm fields).
     */
     ...
     * Load a single Rtm.
     *
     * @param RtmLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RtmLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rtm|array The loaded Rtm as an assoc-array at the
