...
// Slack SDK Adminconversationsekm entity
...
class AdminconversationsekmEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "adminconversationsekm";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AdminconversationsekmEntity($this->_client, $opts);
    }

    /**
     * @param Adminconversationsekm|array $args Adminconversationsekm data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminconversationsekm|array The current Adminconversationsekm data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminconversationsekm fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminconversationsekm fields).
     */
    ...
    /**
     * Load a single Adminconversationsekm.
     *
     * @param AdminconversationsekmLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminconversationsekmLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminconversationsekm|array The loaded Adminconversationsekm as an assoc-array at the
