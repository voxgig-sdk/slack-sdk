...
class UsergroupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UsergroupEntity($this->_client, $opts);
    }

    /**
     * @param Usergroup|array $args Usergroup data (assoc-array) to store.
     */
    ...
    /**
     * @return Usergroup|array The current Usergroup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Usergroup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Usergroup fields).
     */
    ...
    /**
     * List Usergroup items matching the given filter.
     *
     * @param UsergroupListMatch|array|null $reqmatch Match filter (any subset
     *   of Usergroup fields) as an assoc-array; UsergroupListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Usergroup[]|array A list of Usergroup items as assoc-arrays at
     ...
     *
     * @param UsergroupCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UsergroupCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Usergroup|array The created Usergroup as an assoc-array at the
