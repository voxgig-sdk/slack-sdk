...
class AdminuserEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminuserEntity($this->_client, $opts);
    }

    /**
     * @param Adminuser|array $args Adminuser data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminuser|array The current Adminuser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminuser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminuser fields).
     */
    ...
    /**
     * Load a single Adminuser.
     *
     * @param AdminuserLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminuserLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminuser|array The loaded Adminuser as an assoc-array at the
     ...
     *
     * @param AdminuserCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AdminuserCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminuser|array The created Adminuser as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
