...
class BotEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BotEntity($this->_client, $opts);
    }

    /**
     * @param Bot|array $args Bot data (assoc-array) to store.
     */
    ...
    /**
     * @return Bot|array The current Bot data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Bot fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Bot fields).
     */
     ...
     * Load a single Bot.
     *
     * @param BotLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BotLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Bot|array The loaded Bot as an assoc-array at the
