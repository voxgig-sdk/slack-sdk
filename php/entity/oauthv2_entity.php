...
class Oauthv2Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Oauthv2Entity($this->_client, $opts);
    }

    /**
     * @param Oauthv2|array $args Oauthv2 data (assoc-array) to store.
     */
    ...
    /**
     * @return Oauthv2|array The current Oauthv2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Oauthv2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Oauthv2 fields).
     */
    ...
    /**
     * Load a single Oauthv2.
     *
     * @param Oauthv2LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed Oauthv2LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Oauthv2|array The loaded Oauthv2 as an assoc-array at the
