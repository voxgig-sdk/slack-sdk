...
// Slack SDK Adminteamssetting entity
...
class AdminteamssettingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminteamssettingEntity($this->_client, $opts);
    }

    /**
     * @param Adminteamssetting|array $args Adminteamssetting data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminteamssetting|array The current Adminteamssetting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminteamssetting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminteamssetting fields).
     */
    ...
    /**
     * Load a single Adminteamssetting.
     *
     * @param AdminteamssettingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminteamssettingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminteamssetting|array The loaded Adminteamssetting as an assoc-array at the
    ...
    /**
     * Create a new Adminteamssetting.
     *
     * @param AdminteamssettingCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AdminteamssettingCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminteamssetting|array The created Adminteamssetting as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
