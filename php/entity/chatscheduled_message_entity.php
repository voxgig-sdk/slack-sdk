...
// Slack SDK ChatscheduledMessage entity
...
class ChatscheduledMessageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "chatscheduled_message";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ChatscheduledMessageEntity($this->_client, $opts);
    }

    /**
     * @param ChatscheduledMessage|array $args ChatscheduledMessage data (assoc-array) to store.
     */
    ...
    /**
     * @return ChatscheduledMessage|array The current ChatscheduledMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ChatscheduledMessage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ChatscheduledMessage fields).
     */
    ...
    /**
     * List ChatscheduledMessage items matching the given filter.
     *
     * @param ChatscheduledMessageListMatch|array|null $reqmatch Match filter (any subset
     *   of ChatscheduledMessage fields) as an assoc-array; ChatscheduledMessageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ChatscheduledMessage[]|array A list of ChatscheduledMessage items as assoc-arrays at
