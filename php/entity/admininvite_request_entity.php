...
// Slack SDK AdmininviteRequest entity
...
class AdmininviteRequestEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "admininvite_request";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AdmininviteRequestEntity($this->_client, $opts);
    }

    /**
     * @param AdmininviteRequest|array $args AdmininviteRequest data (assoc-array) to store.
     */
    ...
    /**
     * @return AdmininviteRequest|array The current AdmininviteRequest data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AdmininviteRequest fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AdmininviteRequest fields).
     */
    ...
    /**
     * Load a single AdmininviteRequest.
     *
     * @param AdmininviteRequestLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdmininviteRequestLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AdmininviteRequest|array The loaded AdmininviteRequest as an assoc-array at the
    ...
    /**
     * Create a new AdmininviteRequest.
     *
     * @param AdmininviteRequestCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AdmininviteRequestCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AdmininviteRequest|array The created AdmininviteRequest as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
