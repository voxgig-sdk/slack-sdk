...
class AppspermissionsresourceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "appspermissionsresource";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AppspermissionsresourceEntity($this->_client, $opts);
    }

    /**
     * @param Appspermissionsresource|array $args Appspermissionsresource data (assoc-array) to store.
     */
    ...
    /**
     * @return Appspermissionsresource|array The current Appspermissionsresource data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Appspermissionsresource fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Appspermissionsresource fields).
     */
    ...
    /**
     * List Appspermissionsresource items matching the given filter.
     *
     * @param AppspermissionsresourceListMatch|array|null $reqmatch Match filter (any subset
     *   of Appspermissionsresource fields) as an assoc-array; AppspermissionsresourceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Appspermissionsresource[]|array A list of Appspermissionsresource items as assoc-arrays at
