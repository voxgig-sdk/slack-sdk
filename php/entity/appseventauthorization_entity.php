...
// Slack SDK Appseventauthorization entity
...
class AppseventauthorizationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "appseventauthorization";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AppseventauthorizationEntity($this->_client, $opts);
    }

    /**
     * @param Appseventauthorization|array $args Appseventauthorization data (assoc-array) to store.
     */
    ...
    /**
     * @return Appseventauthorization|array The current Appseventauthorization data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Appseventauthorization fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Appseventauthorization fields).
     */
    ...
    /**
     * Load a single Appseventauthorization.
     *
     * @param AppseventauthorizationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AppseventauthorizationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Appseventauthorization|array The loaded Appseventauthorization as an assoc-array at the
