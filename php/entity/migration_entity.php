...
class MigrationEntity
{
     ...
     *
     * @param MigrationListMatch|array|null $reqmatch Match filter (any subset
     *   of Migration fields) as an assoc-array; MigrationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Migration[]|array A list of Migration items as assoc-arrays at
