...
class EmojiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EmojiEntity($this->_client, $opts);
    }

    /**
     * @param Emoji|array $args Emoji data (assoc-array) to store.
     */
    ...
    /**
     * @return Emoji|array The current Emoji data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Emoji fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Emoji fields).
     */
     ...
     * Load a single Emoji.
     *
     * @param EmojiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmojiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Emoji|array The loaded Emoji as an assoc-array at the
