...
class AdminappEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminappEntity($this->_client, $opts);
    }

    /**
     * @param Adminapp|array $args Adminapp data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminapp|array The current Adminapp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminapp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminapp fields).
     */
    ...
    /**
     * Create a new Adminapp.
     *
     * @param AdminappCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AdminappCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminapp|array The created Adminapp as an assoc-array at the
