...
class AdminteamEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminteamEntity($this->_client, $opts);
    }

    /**
     * @param Adminteam|array $args Adminteam data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminteam|array The current Adminteam data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminteam fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminteam fields).
     */
    ...
    /**
     * Load a single Adminteam.
     *
     * @param AdminteamLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminteamLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminteam|array The loaded Adminteam as an assoc-array at the
     ...
     *
     * @param AdminteamCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AdminteamCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminteam|array The created Adminteam as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
