...
// Slack SDK Usergroupsuser entity
...
class UsergroupsuserEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UsergroupsuserEntity($this->_client, $opts);
    }

    /**
     * @param Usergroupsuser|array $args Usergroupsuser data (assoc-array) to store.
     */
    ...
    /**
     * @return Usergroupsuser|array The current Usergroupsuser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Usergroupsuser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Usergroupsuser fields).
     */
    ...
    /**
     * List Usergroupsuser items matching the given filter.
     *
     * @param UsergroupsuserListMatch|array|null $reqmatch Match filter (any subset
     *   of Usergroupsuser fields) as an assoc-array; UsergroupsuserListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Usergroupsuser[]|array A list of Usergroupsuser items as assoc-arrays at
    ...
    /**
     * Create a new Usergroupsuser.
     *
     * @param UsergroupsuserCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UsergroupsuserCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Usergroupsuser|array The created Usergroupsuser as an assoc-array at the
