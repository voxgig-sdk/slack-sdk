...
// Slack SDK AdmininviteRequestsdenied entity
...
class AdmininviteRequestsdeniedEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "admininvite_requestsdenied";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AdmininviteRequestsdeniedEntity($this->_client, $opts);
    }

    /**
     * @param AdmininviteRequestsdenied|array $args AdmininviteRequestsdenied data (assoc-array) to store.
     */
    ...
    /**
     * @return AdmininviteRequestsdenied|array The current AdmininviteRequestsdenied data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AdmininviteRequestsdenied fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AdmininviteRequestsdenied fields).
     */
    ...
    /**
     * Load a single AdmininviteRequestsdenied.
     *
     * @param AdmininviteRequestsdeniedLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdmininviteRequestsdeniedLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AdmininviteRequestsdenied|array The loaded AdmininviteRequestsdenied as an assoc-array at the
