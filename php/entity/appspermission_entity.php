...
// Slack SDK Appspermission entity
...
class AppspermissionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AppspermissionEntity($this->_client, $opts);
    }

    /**
     * @param Appspermission|array $args Appspermission data (assoc-array) to store.
     */
    ...
    /**
     * @return Appspermission|array The current Appspermission data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Appspermission fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Appspermission fields).
     */
    ...
    /**
     * Load a single Appspermission.
     *
     * @param AppspermissionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AppspermissionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Appspermission|array The loaded Appspermission as an assoc-array at the
