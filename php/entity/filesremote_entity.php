...
class FilesremoteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FilesremoteEntity($this->_client, $opts);
    }

    /**
     * @param Filesremote|array $args Filesremote data (assoc-array) to store.
     */
    ...
    /**
     * @return Filesremote|array The current Filesremote data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Filesremote fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Filesremote fields).
     */
    ...
    /**
     * Load a single Filesremote.
     *
     * @param FilesremoteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FilesremoteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Filesremote|array The loaded Filesremote as an assoc-array at the
    ...
    /**
     * Create a new Filesremote.
     *
     * @param FilesremoteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FilesremoteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Filesremote|array The created Filesremote as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
