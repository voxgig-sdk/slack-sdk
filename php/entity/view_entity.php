...
class ViewEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ViewEntity($this->_client, $opts);
    }

    /**
     * @param View|array $args View data (assoc-array) to store.
     */
    ...
    /**
     * @return View|array The current View data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of View fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of View fields).
     */
     ...
     * Load a single View.
     *
     * @param ViewLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ViewLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return View|array The loaded View as an assoc-array at the
