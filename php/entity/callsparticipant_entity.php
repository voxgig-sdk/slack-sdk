...
// Slack SDK Callsparticipant entity
...
class CallsparticipantEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CallsparticipantEntity($this->_client, $opts);
    }

    /**
     * @param Callsparticipant|array $args Callsparticipant data (assoc-array) to store.
     */
    ...
    /**
     * @return Callsparticipant|array The current Callsparticipant data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Callsparticipant fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Callsparticipant fields).
     */
    ...
    /**
     * Create a new Callsparticipant.
     *
     * @param CallsparticipantCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CallsparticipantCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Callsparticipant|array The created Callsparticipant as an assoc-array at the
