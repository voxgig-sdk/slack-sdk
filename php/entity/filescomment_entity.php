...
class FilescommentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FilescommentEntity($this->_client, $opts);
    }

    /**
     * @param Filescomment|array $args Filescomment data (assoc-array) to store.
     */
    ...
    /**
     * @return Filescomment|array The current Filescomment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Filescomment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Filescomment fields).
     */
    ...
    /**
     * Create a new Filescomment.
     *
     * @param FilescommentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FilescommentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Filescomment|array The created Filescomment as an assoc-array at the
