...
// Slack SDK Adminappsrequest entity
...
class AdminappsrequestEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminappsrequestEntity($this->_client, $opts);
    }

    /**
     * @param Adminappsrequest|array $args Adminappsrequest data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminappsrequest|array The current Adminappsrequest data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminappsrequest fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminappsrequest fields).
     */
    ...
    /**
     * Load a single Adminappsrequest.
     *
     * @param AdminappsrequestLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminappsrequestLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminappsrequest|array The loaded Adminappsrequest as an assoc-array at the
