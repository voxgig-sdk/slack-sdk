...
// Slack SDK Conversationsinfo entity
...
class ConversationsinfoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsinfoEntity($this->_client, $opts);
    }

    /**
     * @param Conversationsinfo|array $args Conversationsinfo data (assoc-array) to store.
     */
    ...
    /**
     * @return Conversationsinfo|array The current Conversationsinfo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Conversationsinfo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Conversationsinfo fields).
     */
    ...
    /**
     * Load a single Conversationsinfo.
     *
     * @param ConversationsinfoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsinfoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Conversationsinfo|array The loaded Conversationsinfo as an assoc-array at the
