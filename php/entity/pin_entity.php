...
class PinEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PinEntity($this->_client, $opts);
    }

    /**
     * @param Pin|array $args Pin data (assoc-array) to store.
     */
    ...
    /**
     * @return Pin|array The current Pin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Pin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Pin fields).
     */
     ...
     * Load a single Pin.
     *
     * @param PinLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PinLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pin|array The loaded Pin as an assoc-array at the
     ...
     * Create a new Pin.
     *
     * @param PinCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PinCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pin|array The created Pin as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
