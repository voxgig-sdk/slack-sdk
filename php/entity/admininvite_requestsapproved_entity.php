...
// Slack SDK AdmininviteRequestsapproved entity
...
class AdmininviteRequestsapprovedEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "admininvite_requestsapproved";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AdmininviteRequestsapprovedEntity($this->_client, $opts);
    }

    /**
     * @param AdmininviteRequestsapproved|array $args AdmininviteRequestsapproved data (assoc-array) to store.
     */
    ...
    /**
     * @return AdmininviteRequestsapproved|array The current AdmininviteRequestsapproved data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AdmininviteRequestsapproved fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AdmininviteRequestsapproved fields).
     */
    ...
    /**
     * Load a single AdmininviteRequestsapproved.
     *
     * @param AdmininviteRequestsapprovedLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdmininviteRequestsapprovedLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AdmininviteRequestsapproved|array The loaded AdmininviteRequestsapproved as an assoc-array at the
