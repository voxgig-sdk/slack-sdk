...
// Slack SDK Adminappsapproved entity
...
class AdminappsapprovedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminappsapprovedEntity($this->_client, $opts);
    }

    /**
     * @param Adminappsapproved|array $args Adminappsapproved data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminappsapproved|array The current Adminappsapproved data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminappsapproved fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminappsapproved fields).
     */
    ...
    /**
     * Load a single Adminappsapproved.
     *
     * @param AdminappsapprovedLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminappsapprovedLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminappsapproved|array The loaded Adminappsapproved as an assoc-array at the
