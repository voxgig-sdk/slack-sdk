...
class AuthEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AuthEntity($this->_client, $opts);
    }

    /**
     * @param Auth|array $args Auth data (assoc-array) to store.
     */
    ...
    /**
     * @return Auth|array The current Auth data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Auth fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Auth fields).
     */
     ...
     * Load a single Auth.
     *
     * @param AuthLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AuthLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Auth|array The loaded Auth as an assoc-array at the
