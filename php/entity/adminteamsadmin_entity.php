...
// Slack SDK Adminteamsadmin entity
...
class AdminteamsadminEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminteamsadminEntity($this->_client, $opts);
    }

    /**
     * @param Adminteamsadmin|array $args Adminteamsadmin data (assoc-array) to store.
     */
    ...
    /**
     * @return Adminteamsadmin|array The current Adminteamsadmin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adminteamsadmin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adminteamsadmin fields).
     */
    ...
    /**
     * Load a single Adminteamsadmin.
     *
     * @param AdminteamsadminLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminteamsadminLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adminteamsadmin|array The loaded Adminteamsadmin as an assoc-array at the
