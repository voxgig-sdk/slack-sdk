...
class ChatEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ChatEntity($this->_client, $opts);
    }

    /**
     * @param Chat|array $args Chat data (assoc-array) to store.
     */
    ...
    /**
     * @return Chat|array The current Chat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Chat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Chat fields).
     */
     ...
     * Load a single Chat.
     *
     * @param ChatLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ChatLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Chat|array The loaded Chat as an assoc-array at the
     ...
     * Create a new Chat.
     *
     * @param ChatCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ChatCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Chat|array The created Chat as an assoc-array at the
     *   SDK boundary; throws SlackError on failure (item-5 convention).
     */
