...
// Slack SDK Appspermissionsscope entity
...
class AppspermissionsscopeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "appspermissionsscope";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AppspermissionsscopeEntity($this->_client, $opts);
    }

    /**
     * @param Appspermissionsscope|array $args Appspermissionsscope data (assoc-array) to store.
     */
    ...
    /**
     * @return Appspermissionsscope|array The current Appspermissionsscope data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Appspermissionsscope fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Appspermissionsscope fields).
     */
    ...
    /**
     * Load a single Appspermissionsscope.
     *
     * @param AppspermissionsscopeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AppspermissionsscopeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Appspermissionsscope|array The loaded Appspermissionsscope as an assoc-array at the
