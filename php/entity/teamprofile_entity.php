...
class TeamprofileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TeamprofileEntity($this->_client, $opts);
    }

    /**
     * @param Teamprofile|array $args Teamprofile data (assoc-array) to store.
     */
    ...
    /**
     * @return Teamprofile|array The current Teamprofile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Teamprofile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Teamprofile fields).
     */
    ...
    /**
     * Load a single Teamprofile.
     *
     * @param TeamprofileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TeamprofileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Teamprofile|array The loaded Teamprofile as an assoc-array at the
