...
class SlackPagingFeature extends SlackBaseFeature
{
    ...
    private function _graphql_pre_request(SlackContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(SlackContext $ctx): bool
    {
