...
// Slack SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SlackTestFeature extends SlackBaseFeature
{
    ...
    public function init(SlackContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SlackContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SlackContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SlackContext $ctx, $op, $args): array
    {
