...
class SlackTestRunner
{
    ...
    {
        $live = self::getenv('SLACK_TEST_LIVE');
        $override = self::getenv('SLACK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SLACK_TEST_EXPLAIN');
...
class_alias('SlackTestRunner', 'Runner');
class_alias('SlackHelpers', 'Helpers');
