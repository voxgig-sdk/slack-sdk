...
class Oauthv2DirectTest extends TestCase
{
    public function test_direct_load_oauthv2(): void
    {
        $setup = oauthv2_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-oauthv2", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
