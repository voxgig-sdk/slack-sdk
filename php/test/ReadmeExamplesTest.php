...
// Slack SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SlackSDK::test)
...
{
    private const SDK_CLASS = 'SlackSDK';
    ...
    private const SDK_BASE = 'slack_sdk';
