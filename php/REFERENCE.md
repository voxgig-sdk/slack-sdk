...
#### `Conversationsinfo($data = null)`

Create a new `ConversationsinfoEntity` instance. Pass `null` for no initial data.

#### `Conversationslist($data = null)`

Create a new `ConversationslistEntity` instance. Pass `null` for no initial data.
