...
// Slack SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SlackMakeRequest
{
    public static function call(SlackContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SlackResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SlackResponse($fetched);
        } else {
