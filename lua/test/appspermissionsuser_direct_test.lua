...
describe("AppspermissionsuserDirect", function()
  it("should direct-load-appspermissionsuser", function()
    local setup = appspermissionsuser_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-appspermissionsuser", setup.live and "live" or "unit")
...
function appspermissionsuser_direct_setup(mockres)
