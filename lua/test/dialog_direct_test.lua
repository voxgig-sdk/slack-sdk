...
describe("DialogDirect", function()
  it("should direct-load-dialog", function()
    local setup = dialog_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dialog", setup.live and "live" or "unit")
...
function dialog_direct_setup(mockres)
