...
describe("AdminteamsownerDirect", function()
  it("should direct-load-adminteamsowner", function()
    local setup = adminteamsowner_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminteamsowner", setup.live and "live" or "unit")
...
function adminteamsowner_direct_setup(mockres)
