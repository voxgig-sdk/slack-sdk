...
describe("AdminteamssettingDirect", function()
  it("should direct-load-adminteamssetting", function()
    local setup = adminteamssetting_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminteamssetting", setup.live and "live" or "unit")
...
function adminteamssetting_direct_setup(mockres)
