...
describe("MigrationDirect", function()
  it("should direct-list-migration", function()
    local setup = migration_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-migration", setup.live and "live" or "unit")
...
function migration_direct_setup(mockres)
