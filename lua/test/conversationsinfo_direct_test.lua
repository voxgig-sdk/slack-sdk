...
describe("ConversationsinfoDirect", function()
  it("should direct-load-conversationsinfo", function()
    local setup = conversationsinfo_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-conversationsinfo", setup.live and "live" or "unit")
...
function conversationsinfo_direct_setup(mockres)
