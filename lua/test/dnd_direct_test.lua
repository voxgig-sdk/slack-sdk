...
describe("DndDirect", function()
  it("should direct-load-dnd", function()
    local setup = dnd_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dnd", setup.live and "live" or "unit")
...
function dnd_direct_setup(mockres)
