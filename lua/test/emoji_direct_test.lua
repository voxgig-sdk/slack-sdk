...
describe("EmojiDirect", function()
  it("should direct-load-emoji", function()
    local setup = emoji_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-emoji", setup.live and "live" or "unit")
...
function emoji_direct_setup(mockres)
