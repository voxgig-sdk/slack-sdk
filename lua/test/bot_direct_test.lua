...
describe("BotDirect", function()
  it("should direct-load-bot", function()
    local setup = bot_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-bot", setup.live and "live" or "unit")
...
function bot_direct_setup(mockres)
