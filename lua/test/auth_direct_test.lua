...
describe("AuthDirect", function()
  it("should direct-load-auth", function()
    local setup = auth_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-auth", setup.live and "live" or "unit")
...
function auth_direct_setup(mockres)
