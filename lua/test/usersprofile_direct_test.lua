...
describe("UsersprofileDirect", function()
  it("should direct-load-usersprofile", function()
    local setup = usersprofile_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-usersprofile", setup.live and "live" or "unit")
...
function usersprofile_direct_setup(mockres)
