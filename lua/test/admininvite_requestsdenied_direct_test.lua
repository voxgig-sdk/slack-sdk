...
describe("AdmininviteRequestsdeniedDirect", function()
  it("should direct-load-admininvite_requestsdenied", function()
    local setup = admininvite_requestsdenied_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-admininvite_requestsdenied", setup.live and "live" or "unit")
...
function admininvite_requestsdenied_direct_setup(mockres)
