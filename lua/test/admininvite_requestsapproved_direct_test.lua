...
describe("AdmininviteRequestsapprovedDirect", function()
  it("should direct-load-admininvite_requestsapproved", function()
    local setup = admininvite_requestsapproved_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-admininvite_requestsapproved", setup.live and "live" or "unit")
...
function admininvite_requestsapproved_direct_setup(mockres)
