...
describe("AdminappsapprovedDirect", function()
  it("should direct-load-adminappsapproved", function()
    local setup = adminappsapproved_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminappsapproved", setup.live and "live" or "unit")
...
function adminappsapproved_direct_setup(mockres)
