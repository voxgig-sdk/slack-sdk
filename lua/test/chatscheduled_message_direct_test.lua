...
describe("ChatscheduledMessageDirect", function()
  it("should direct-list-chatscheduled_message", function()
    local setup = chatscheduled_message_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-chatscheduled_message", setup.live and "live" or "unit")
...
function chatscheduled_message_direct_setup(mockres)
