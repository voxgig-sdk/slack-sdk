...
describe("AdminemojiDirect", function()
  it("should direct-load-adminemoji", function()
    local setup = adminemoji_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminemoji", setup.live and "live" or "unit")
...
function adminemoji_direct_setup(mockres)
