...
describe("TeamprofileDirect", function()
  it("should direct-load-teamprofile", function()
    local setup = teamprofile_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-teamprofile", setup.live and "live" or "unit")
...
function teamprofile_direct_setup(mockres)
