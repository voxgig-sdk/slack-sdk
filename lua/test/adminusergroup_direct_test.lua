...
describe("AdminusergroupDirect", function()
  it("should direct-load-adminusergroup", function()
    local setup = adminusergroup_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminusergroup", setup.live and "live" or "unit")
...
function adminusergroup_direct_setup(mockres)
