...
describe("AdmininviteRequestDirect", function()
  it("should direct-load-admininvite_request", function()
    local setup = admininvite_request_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-admininvite_request", setup.live and "live" or "unit")
...
function admininvite_request_direct_setup(mockres)
