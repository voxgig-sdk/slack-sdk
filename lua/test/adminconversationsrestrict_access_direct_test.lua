...
describe("AdminconversationsrestrictAccessDirect", function()
  it("should direct-load-adminconversationsrestrict_access", function()
    local setup = adminconversationsrestrict_access_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminconversationsrestrict_access", setup.live and "live" or "unit")
...
function adminconversationsrestrict_access_direct_setup(mockres)
