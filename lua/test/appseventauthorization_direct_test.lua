...
describe("AppseventauthorizationDirect", function()
  it("should direct-load-appseventauthorization", function()
    local setup = appseventauthorization_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-appseventauthorization", setup.live and "live" or "unit")
...
function appseventauthorization_direct_setup(mockres)
