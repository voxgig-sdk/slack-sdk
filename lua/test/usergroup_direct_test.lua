...
describe("UsergroupDirect", function()
  it("should direct-list-usergroup", function()
    local setup = usergroup_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-usergroup", setup.live and "live" or "unit")
...
function usergroup_direct_setup(mockres)
