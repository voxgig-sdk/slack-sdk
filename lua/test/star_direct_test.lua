...
describe("StarDirect", function()
  it("should direct-list-star", function()
    local setup = star_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-star", setup.live and "live" or "unit")
...
function star_direct_setup(mockres)
