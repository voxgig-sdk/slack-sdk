...
describe("AdminteamsadminDirect", function()
  it("should direct-load-adminteamsadmin", function()
    local setup = adminteamsadmin_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminteamsadmin", setup.live and "live" or "unit")
...
function adminteamsadmin_direct_setup(mockres)
