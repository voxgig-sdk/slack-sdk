...
describe("Oauthv2Direct", function()
  it("should direct-load-oauthv2", function()
    local setup = oauthv2_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-oauthv2", setup.live and "live" or "unit")
...
function oauthv2_direct_setup(mockres)
