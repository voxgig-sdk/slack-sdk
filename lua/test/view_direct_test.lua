...
describe("ViewDirect", function()
  it("should direct-load-view", function()
    local setup = view_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-view", setup.live and "live" or "unit")
...
function view_direct_setup(mockres)
