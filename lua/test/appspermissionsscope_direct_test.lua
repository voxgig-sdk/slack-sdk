...
describe("AppspermissionsscopeDirect", function()
  it("should direct-load-appspermissionsscope", function()
    local setup = appspermissionsscope_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-appspermissionsscope", setup.live and "live" or "unit")
...
function appspermissionsscope_direct_setup(mockres)
