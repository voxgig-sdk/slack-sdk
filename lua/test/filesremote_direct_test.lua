...
describe("FilesremoteDirect", function()
  it("should direct-load-filesremote", function()
    local setup = filesremote_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-filesremote", setup.live and "live" or "unit")
...
function filesremote_direct_setup(mockres)
