...
describe("AdminuserDirect", function()
  it("should direct-load-adminuser", function()
    local setup = adminuser_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminuser", setup.live and "live" or "unit")
...
function adminuser_direct_setup(mockres)
