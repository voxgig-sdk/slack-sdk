...
describe("AdminappsrequestDirect", function()
  it("should direct-load-adminappsrequest", function()
    local setup = adminappsrequest_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminappsrequest", setup.live and "live" or "unit")
...
function adminappsrequest_direct_setup(mockres)
