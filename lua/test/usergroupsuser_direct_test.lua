...
describe("UsergroupsuserDirect", function()
  it("should direct-list-usergroupsuser", function()
    local setup = usergroupsuser_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-usergroupsuser", setup.live and "live" or "unit")
...
function usergroupsuser_direct_setup(mockres)
