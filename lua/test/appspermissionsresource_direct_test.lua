...
describe("AppspermissionsresourceDirect", function()
  it("should direct-list-appspermissionsresource", function()
    local setup = appspermissionsresource_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-appspermissionsresource", setup.live and "live" or "unit")
...
function appspermissionsresource_direct_setup(mockres)
