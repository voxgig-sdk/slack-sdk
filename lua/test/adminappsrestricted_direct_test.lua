...
describe("AdminappsrestrictedDirect", function()
  it("should direct-load-adminappsrestricted", function()
    local setup = adminappsrestricted_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminappsrestricted", setup.live and "live" or "unit")
...
function adminappsrestricted_direct_setup(mockres)
