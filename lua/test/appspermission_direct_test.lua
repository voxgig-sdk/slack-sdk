...
describe("AppspermissionDirect", function()
  it("should direct-load-appspermission", function()
    local setup = appspermission_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-appspermission", setup.live and "live" or "unit")
...
function appspermission_direct_setup(mockres)
