...
describe("ConversationslistDirect", function()
  it("should direct-list-conversationslist", function()
    local setup = conversationslist_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-conversationslist", setup.live and "live" or "unit")
...
function conversationslist_direct_setup(mockres)
