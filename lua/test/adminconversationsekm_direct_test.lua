...
describe("AdminconversationsekmDirect", function()
  it("should direct-load-adminconversationsekm", function()
    local setup = adminconversationsekm_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminconversationsekm", setup.live and "live" or "unit")
...
function adminconversationsekm_direct_setup(mockres)
