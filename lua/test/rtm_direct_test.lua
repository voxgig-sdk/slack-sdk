...
describe("RtmDirect", function()
  it("should direct-load-rtm", function()
    local setup = rtm_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rtm", setup.live and "live" or "unit")
...
function rtm_direct_setup(mockres)
