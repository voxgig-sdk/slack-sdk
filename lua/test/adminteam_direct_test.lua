...
describe("AdminteamDirect", function()
  it("should direct-load-adminteam", function()
    local setup = adminteam_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminteam", setup.live and "live" or "unit")
...
function adminteam_direct_setup(mockres)
