...
describe("AdminconversationDirect", function()
  it("should direct-list-adminconversation", function()
    local setup = adminconversation_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-adminconversation", setup.live and "live" or "unit")
  ...
  it("should direct-load-adminconversation", function()
    local setup = adminconversation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adminconversation", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function adminconversation_direct_setup(mockres)
