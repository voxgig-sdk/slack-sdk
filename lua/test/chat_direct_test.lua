...
describe("ChatDirect", function()
  it("should direct-load-chat", function()
    local setup = chat_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-chat", setup.live and "live" or "unit")
...
function chat_direct_setup(mockres)
