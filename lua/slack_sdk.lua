...
-- Idiomatic facade: client:Conversationsinfo():list() / client:Conversationsinfo():load({ id = ... })
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function SlackSDK:Conversationsinfo(data)
  local EntityMod = require("entity.conversationsinfo_entity")
  if data == nil then
    if self._conversationsinfo == nil then
      self._conversationsinfo = EntityMod.new(self, nil)
    end
    return self._conversationsinfo
  end
  return EntityMod.new(self, data)
end


-- Idiomatic facade: client:Conversationslist():list() / client:Conversationslist():load({ id = ... })
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function SlackSDK:Conversationslist(data)
  local EntityMod = require("entity.conversationslist_entity")
  if data == nil then
    if self._conversationslist == nil then
      self._conversationslist = EntityMod.new(self, nil)
    end
    return self._conversationslist
  end
  return EntityMod.new(self, data)
end
