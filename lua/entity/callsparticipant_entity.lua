...
local CallsparticipantEntity = {}
CallsparticipantEntity.__index = CallsparticipantEntity


function CallsparticipantEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CallsparticipantEntity)
  self._name = "callsparticipant"
  self._client = client
...
function CallsparticipantEntity:get_name()
  return self._name
end


function CallsparticipantEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CallsparticipantEntity.new(self._client, opts)
end
...
function CallsparticipantEntity:mark_deleted()
  self._deleted = true
end


function CallsparticipantEntity:deleted()
  return true == self._deleted
end


function CallsparticipantEntity:data_set(args)
  if args ~= nil then
...
function CallsparticipantEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CallsparticipantEntity:match_set(args)
  if args ~= nil then
...
function CallsparticipantEntity:match_get()
...
function CallsparticipantEntity:stream(action, args, callopts)
...
---@param reqdata CallsparticipantCreateData
---@param ctrl? table
---@return Callsparticipant
---@return string? err
function CallsparticipantEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CallsparticipantEntity:_run_op(ctx, post_done)
  local utility = self._utility
