...
local Oauthv2Entity = {}
Oauthv2Entity.__index = Oauthv2Entity


function Oauthv2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Oauthv2Entity)
  self._name = "oauthv2"
  self._client = client
...
function Oauthv2Entity:get_name()
  return self._name
end


function Oauthv2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Oauthv2Entity.new(self._client, opts)
end
...
function Oauthv2Entity:mark_deleted()
  self._deleted = true
end


function Oauthv2Entity:deleted()
  return true == self._deleted
end


function Oauthv2Entity:data_set(args)
  if args ~= nil then
...
function Oauthv2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Oauthv2Entity:match_set(args)
  if args ~= nil then
...
function Oauthv2Entity:match_get()
...
function Oauthv2Entity:stream(action, args, callopts)
...
---@param reqmatch Oauthv2LoadMatch
---@param ctrl? table
---@return Oauthv2
---@return string? err
function Oauthv2Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function Oauthv2Entity:_run_op(ctx, post_done)
  local utility = self._utility
