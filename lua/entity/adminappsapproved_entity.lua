...
local AdminappsapprovedEntity = {}
AdminappsapprovedEntity.__index = AdminappsapprovedEntity


function AdminappsapprovedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminappsapprovedEntity)
  self._name = "adminappsapproved"
  self._client = client
...
function AdminappsapprovedEntity:get_name()
  return self._name
end


function AdminappsapprovedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminappsapprovedEntity.new(self._client, opts)
end
...
function AdminappsapprovedEntity:mark_deleted()
  self._deleted = true
end


function AdminappsapprovedEntity:deleted()
  return true == self._deleted
end


function AdminappsapprovedEntity:data_set(args)
  if args ~= nil then
...
function AdminappsapprovedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminappsapprovedEntity:match_set(args)
  if args ~= nil then
...
function AdminappsapprovedEntity:match_get()
...
function AdminappsapprovedEntity:stream(action, args, callopts)
...
---@param reqmatch AdminappsapprovedLoadMatch
---@param ctrl? table
---@return Adminappsapproved
---@return string? err
function AdminappsapprovedEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AdminappsapprovedEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AdminappsapprovedEntity
