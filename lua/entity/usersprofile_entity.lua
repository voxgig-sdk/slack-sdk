...
local UsersprofileEntity = {}
UsersprofileEntity.__index = UsersprofileEntity


function UsersprofileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UsersprofileEntity)
  self._name = "usersprofile"
  self._client = client
...
function UsersprofileEntity:get_name()
  return self._name
end


function UsersprofileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UsersprofileEntity.new(self._client, opts)
end
...
function UsersprofileEntity:mark_deleted()
  self._deleted = true
end


function UsersprofileEntity:deleted()
  return true == self._deleted
end


function UsersprofileEntity:data_set(args)
  if args ~= nil then
...
function UsersprofileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UsersprofileEntity:match_set(args)
  if args ~= nil then
...
function UsersprofileEntity:match_get()
...
function UsersprofileEntity:stream(action, args, callopts)
...
---@param reqmatch UsersprofileLoadMatch
---@param ctrl? table
---@return Usersprofile
---@return string? err
function UsersprofileEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata UsersprofileCreateData
---@param ctrl? table
---@return Usersprofile
---@return string? err
function UsersprofileEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function UsersprofileEntity:_run_op(ctx, post_done)
  local utility = self._utility
