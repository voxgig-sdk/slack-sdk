...
local TeamprofileEntity = {}
TeamprofileEntity.__index = TeamprofileEntity


function TeamprofileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TeamprofileEntity)
  self._name = "teamprofile"
  self._client = client
...
function TeamprofileEntity:get_name()
  return self._name
end


function TeamprofileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TeamprofileEntity.new(self._client, opts)
end
...
function TeamprofileEntity:mark_deleted()
  self._deleted = true
end


function TeamprofileEntity:deleted()
  return true == self._deleted
end


function TeamprofileEntity:data_set(args)
  if args ~= nil then
...
function TeamprofileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TeamprofileEntity:match_set(args)
  if args ~= nil then
...
function TeamprofileEntity:match_get()
...
function TeamprofileEntity:stream(action, args, callopts)
...
---@param reqmatch TeamprofileLoadMatch
---@param ctrl? table
---@return Teamprofile
---@return string? err
function TeamprofileEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function TeamprofileEntity:_run_op(ctx, post_done)
  local utility = self._utility
