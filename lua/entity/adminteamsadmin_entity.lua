...
local AdminteamsadminEntity = {}
AdminteamsadminEntity.__index = AdminteamsadminEntity


function AdminteamsadminEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminteamsadminEntity)
  self._name = "adminteamsadmin"
  self._client = client
...
function AdminteamsadminEntity:get_name()
  return self._name
end


function AdminteamsadminEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminteamsadminEntity.new(self._client, opts)
end
...
function AdminteamsadminEntity:mark_deleted()
  self._deleted = true
end


function AdminteamsadminEntity:deleted()
  return true == self._deleted
end


function AdminteamsadminEntity:data_set(args)
  if args ~= nil then
...
function AdminteamsadminEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminteamsadminEntity:match_set(args)
  if args ~= nil then
...
function AdminteamsadminEntity:match_get()
...
function AdminteamsadminEntity:stream(action, args, callopts)
...
---@param reqmatch AdminteamsadminLoadMatch
---@param ctrl? table
---@return Adminteamsadmin
---@return string? err
function AdminteamsadminEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AdminteamsadminEntity:_run_op(ctx, post_done)
  local utility = self._utility
