...
local AdminteamsownerEntity = {}
AdminteamsownerEntity.__index = AdminteamsownerEntity


function AdminteamsownerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminteamsownerEntity)
  self._name = "adminteamsowner"
  self._client = client
...
function AdminteamsownerEntity:get_name()
  return self._name
end


function AdminteamsownerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminteamsownerEntity.new(self._client, opts)
end
...
function AdminteamsownerEntity:mark_deleted()
  self._deleted = true
end


function AdminteamsownerEntity:deleted()
  return true == self._deleted
end


function AdminteamsownerEntity:data_set(args)
  if args ~= nil then
...
function AdminteamsownerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminteamsownerEntity:match_set(args)
  if args ~= nil then
...
function AdminteamsownerEntity:match_get()
...
function AdminteamsownerEntity:stream(action, args, callopts)
...
---@param reqmatch AdminteamsownerLoadMatch
---@param ctrl? table
---@return Adminteamsowner
---@return string? err
function AdminteamsownerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AdminteamsownerEntity:_run_op(ctx, post_done)
  local utility = self._utility
