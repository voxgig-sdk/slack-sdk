...
local AdmininviteRequestsdeniedEntity = {}
AdmininviteRequestsdeniedEntity.__index = AdmininviteRequestsdeniedEntity


function AdmininviteRequestsdeniedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdmininviteRequestsdeniedEntity)
  self._name = "admininvite_requestsdenied"
  self._client = client
...
function AdmininviteRequestsdeniedEntity:get_name()
  return self._name
end


function AdmininviteRequestsdeniedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdmininviteRequestsdeniedEntity.new(self._client, opts)
end
...
function AdmininviteRequestsdeniedEntity:mark_deleted()
  self._deleted = true
end


function AdmininviteRequestsdeniedEntity:deleted()
  return true == self._deleted
end


function AdmininviteRequestsdeniedEntity:data_set(args)
  if args ~= nil then
...
function AdmininviteRequestsdeniedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdmininviteRequestsdeniedEntity:match_set(args)
  if args ~= nil then
...
function AdmininviteRequestsdeniedEntity:match_get()
...
function AdmininviteRequestsdeniedEntity:stream(action, args, callopts)
...
---@param reqmatch AdmininviteRequestsdeniedLoadMatch
---@param ctrl? table
---@return AdmininviteRequestsdenied
---@return string? err
function AdmininviteRequestsdeniedEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AdmininviteRequestsdeniedEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AdmininviteRequestsdeniedEntity
