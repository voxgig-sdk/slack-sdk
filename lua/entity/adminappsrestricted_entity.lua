...
local AdminappsrestrictedEntity = {}
AdminappsrestrictedEntity.__index = AdminappsrestrictedEntity


function AdminappsrestrictedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminappsrestrictedEntity)
  self._name = "adminappsrestricted"
  self._client = client
...
function AdminappsrestrictedEntity:get_name()
  return self._name
end


function AdminappsrestrictedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminappsrestrictedEntity.new(self._client, opts)
end
...
function AdminappsrestrictedEntity:mark_deleted()
  self._deleted = true
end


function AdminappsrestrictedEntity:deleted()
  return true == self._deleted
end


function AdminappsrestrictedEntity:data_set(args)
  if args ~= nil then
...
function AdminappsrestrictedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminappsrestrictedEntity:match_set(args)
  if args ~= nil then
...
function AdminappsrestrictedEntity:match_get()
...
function AdminappsrestrictedEntity:stream(action, args, callopts)
...
---@param reqmatch AdminappsrestrictedLoadMatch
---@param ctrl? table
---@return Adminappsrestricted
---@return string? err
function AdminappsrestrictedEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AdminappsrestrictedEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AdminappsrestrictedEntity
