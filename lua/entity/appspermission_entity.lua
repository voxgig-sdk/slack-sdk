...
local AppspermissionEntity = {}
AppspermissionEntity.__index = AppspermissionEntity


function AppspermissionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AppspermissionEntity)
  self._name = "appspermission"
  self._client = client
...
function AppspermissionEntity:get_name()
  return self._name
end


function AppspermissionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AppspermissionEntity.new(self._client, opts)
end
...
function AppspermissionEntity:mark_deleted()
  self._deleted = true
end


function AppspermissionEntity:deleted()
  return true == self._deleted
end


function AppspermissionEntity:data_set(args)
  if args ~= nil then
...
function AppspermissionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AppspermissionEntity:match_set(args)
  if args ~= nil then
...
function AppspermissionEntity:match_get()
...
function AppspermissionEntity:stream(action, args, callopts)
...
---@param reqmatch AppspermissionLoadMatch
---@param ctrl? table
---@return Appspermission
---@return string? err
function AppspermissionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AppspermissionEntity:_run_op(ctx, post_done)
  local utility = self._utility
