...
local AdminconversationsekmEntity = {}
AdminconversationsekmEntity.__index = AdminconversationsekmEntity


function AdminconversationsekmEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminconversationsekmEntity)
  self._name = "adminconversationsekm"
  self._client = client
...
function AdminconversationsekmEntity:get_name()
  return self._name
end


function AdminconversationsekmEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminconversationsekmEntity.new(self._client, opts)
end
...
function AdminconversationsekmEntity:mark_deleted()
  self._deleted = true
end


function AdminconversationsekmEntity:deleted()
  return true == self._deleted
end


function AdminconversationsekmEntity:data_set(args)
  if args ~= nil then
...
function AdminconversationsekmEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminconversationsekmEntity:match_set(args)
  if args ~= nil then
...
function AdminconversationsekmEntity:match_get()
...
function AdminconversationsekmEntity:stream(action, args, callopts)
...
---@param reqmatch AdminconversationsekmLoadMatch
---@param ctrl? table
---@return Adminconversationsekm
---@return string? err
function AdminconversationsekmEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AdminconversationsekmEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AdminconversationsekmEntity
