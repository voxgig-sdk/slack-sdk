...
local AdminconversationsrestrictAccessEntity = {}
AdminconversationsrestrictAccessEntity.__index = AdminconversationsrestrictAccessEntity


function AdminconversationsrestrictAccessEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminconversationsrestrictAccessEntity)
  self._name = "adminconversationsrestrict_access"
  self._client = client
...
function AdminconversationsrestrictAccessEntity:get_name()
  return self._name
end


function AdminconversationsrestrictAccessEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminconversationsrestrictAccessEntity.new(self._client, opts)
end
...
function AdminconversationsrestrictAccessEntity:mark_deleted()
  self._deleted = true
end


function AdminconversationsrestrictAccessEntity:deleted()
  return true == self._deleted
end


function AdminconversationsrestrictAccessEntity:data_set(args)
  if args ~= nil then
...
function AdminconversationsrestrictAccessEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminconversationsrestrictAccessEntity:match_set(args)
  if args ~= nil then
...
function AdminconversationsrestrictAccessEntity:match_get()
...
function AdminconversationsrestrictAccessEntity:stream(action, args, callopts)
...
---@param reqmatch AdminconversationsrestrictAccessLoadMatch
---@param ctrl? table
---@return AdminconversationsrestrictAccess
---@return string? err
function AdminconversationsrestrictAccessEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AdminconversationsrestrictAccessCreateData
---@param ctrl? table
---@return AdminconversationsrestrictAccess
---@return string? err
function AdminconversationsrestrictAccessEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function AdminconversationsrestrictAccessEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AdminconversationsrestrictAccessEntity
