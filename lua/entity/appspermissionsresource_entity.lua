-- Slack SDK Appspermissionsresource entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AppspermissionsresourceEntity = {}
AppspermissionsresourceEntity.__index = AppspermissionsresourceEntity


function AppspermissionsresourceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AppspermissionsresourceEntity)
  self._name = "appspermissionsresource"
  self._client = client
...
function AppspermissionsresourceEntity:get_name()
  return self._name
end


function AppspermissionsresourceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AppspermissionsresourceEntity.new(self._client, opts)
end
...
function AppspermissionsresourceEntity:mark_deleted()
  self._deleted = true
end


function AppspermissionsresourceEntity:deleted()
  return true == self._deleted
end


function AppspermissionsresourceEntity:data_set(args)
  if args ~= nil then
...
function AppspermissionsresourceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AppspermissionsresourceEntity:match_set(args)
  if args ~= nil then
...
function AppspermissionsresourceEntity:match_get()
...
function AppspermissionsresourceEntity:stream(action, args, callopts)
...
---@param reqmatch AppspermissionsresourceListMatch
---@param ctrl? table
---@return Appspermissionsresource[]
---@return string? err
function AppspermissionsresourceEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AppspermissionsresourceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AppspermissionsresourceEntity
