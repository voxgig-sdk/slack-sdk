...
local ChatscheduledMessageEntity = {}
ChatscheduledMessageEntity.__index = ChatscheduledMessageEntity


function ChatscheduledMessageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ChatscheduledMessageEntity)
  self._name = "chatscheduled_message"
  self._client = client
...
function ChatscheduledMessageEntity:get_name()
  return self._name
end


function ChatscheduledMessageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ChatscheduledMessageEntity.new(self._client, opts)
end
...
function ChatscheduledMessageEntity:mark_deleted()
  self._deleted = true
end


function ChatscheduledMessageEntity:deleted()
  return true == self._deleted
end


function ChatscheduledMessageEntity:data_set(args)
  if args ~= nil then
...
function ChatscheduledMessageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ChatscheduledMessageEntity:match_set(args)
  if args ~= nil then
...
function ChatscheduledMessageEntity:match_get()
...
function ChatscheduledMessageEntity:stream(action, args, callopts)
...
---@param reqmatch ChatscheduledMessageListMatch
---@param ctrl? table
---@return ChatscheduledMessage[]
---@return string? err
function ChatscheduledMessageEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ChatscheduledMessageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ChatscheduledMessageEntity
