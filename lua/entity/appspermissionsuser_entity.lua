...
local AppspermissionsuserEntity = {}
AppspermissionsuserEntity.__index = AppspermissionsuserEntity


function AppspermissionsuserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AppspermissionsuserEntity)
  self._name = "appspermissionsuser"
  self._client = client
...
function AppspermissionsuserEntity:get_name()
  return self._name
end


function AppspermissionsuserEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AppspermissionsuserEntity.new(self._client, opts)
end
...
function AppspermissionsuserEntity:mark_deleted()
  self._deleted = true
end


function AppspermissionsuserEntity:deleted()
  return true == self._deleted
end


function AppspermissionsuserEntity:data_set(args)
  if args ~= nil then
...
function AppspermissionsuserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AppspermissionsuserEntity:match_set(args)
  if args ~= nil then
...
function AppspermissionsuserEntity:match_get()
...
function AppspermissionsuserEntity:stream(action, args, callopts)
...
---@param reqmatch AppspermissionsuserLoadMatch
---@param ctrl? table
---@return Appspermissionsuser
---@return string? err
function AppspermissionsuserEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AppspermissionsuserEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AppspermissionsuserEntity
