...
local ConversationslistEntity = {}
ConversationslistEntity.__index = ConversationslistEntity


function ConversationslistEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationslistEntity)
  self._name = "conversationslist"
  self._client = client
...
function ConversationslistEntity:get_name()
  return self._name
end


function ConversationslistEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationslistEntity.new(self._client, opts)
end
...
function ConversationslistEntity:mark_deleted()
  self._deleted = true
end


function ConversationslistEntity:deleted()
  return true == self._deleted
end


function ConversationslistEntity:data_set(args)
  if args ~= nil then
...
function ConversationslistEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationslistEntity:match_set(args)
  if args ~= nil then
...
function ConversationslistEntity:match_get()
...
function ConversationslistEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationslistListMatch
---@param ctrl? table
---@return Conversationslist[]
---@return string? err
function ConversationslistEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationslistEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationslistEntity
