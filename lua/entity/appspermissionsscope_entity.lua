...
local AppspermissionsscopeEntity = {}
AppspermissionsscopeEntity.__index = AppspermissionsscopeEntity


function AppspermissionsscopeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AppspermissionsscopeEntity)
  self._name = "appspermissionsscope"
  self._client = client
...
function AppspermissionsscopeEntity:get_name()
  return self._name
end


function AppspermissionsscopeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AppspermissionsscopeEntity.new(self._client, opts)
end
...
function AppspermissionsscopeEntity:mark_deleted()
  self._deleted = true
end


function AppspermissionsscopeEntity:deleted()
  return true == self._deleted
end


function AppspermissionsscopeEntity:data_set(args)
  if args ~= nil then
...
function AppspermissionsscopeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AppspermissionsscopeEntity:match_set(args)
  if args ~= nil then
...
function AppspermissionsscopeEntity:match_get()
...
function AppspermissionsscopeEntity:stream(action, args, callopts)
...
---@param reqmatch AppspermissionsscopeLoadMatch
---@param ctrl? table
---@return Appspermissionsscope
---@return string? err
function AppspermissionsscopeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AppspermissionsscopeEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AppspermissionsscopeEntity
