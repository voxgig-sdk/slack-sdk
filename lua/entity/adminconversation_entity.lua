...
local AdminconversationEntity = {}
AdminconversationEntity.__index = AdminconversationEntity


function AdminconversationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminconversationEntity)
  self._name = "adminconversation"
  self._client = client
...
function AdminconversationEntity:get_name()
  return self._name
end


function AdminconversationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminconversationEntity.new(self._client, opts)
end
...
function AdminconversationEntity:mark_deleted()
  self._deleted = true
end


function AdminconversationEntity:deleted()
  return true == self._deleted
end


function AdminconversationEntity:data_set(args)
  if args ~= nil then
...
function AdminconversationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminconversationEntity:match_set(args)
  if args ~= nil then
...
function AdminconversationEntity:match_get()
...
function AdminconversationEntity:stream(action, args, callopts)
...
---@param reqmatch AdminconversationLoadMatch
---@param ctrl? table
---@return Adminconversation
---@return string? err
function AdminconversationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch AdminconversationListMatch
---@param ctrl? table
---@return Adminconversation[]
---@return string? err
function AdminconversationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata AdminconversationCreateData
---@param ctrl? table
---@return Adminconversation
---@return string? err
function AdminconversationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function AdminconversationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AdminconversationEntity
