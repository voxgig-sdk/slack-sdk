...
local AdmininviteRequestsapprovedEntity = {}
AdmininviteRequestsapprovedEntity.__index = AdmininviteRequestsapprovedEntity


function AdmininviteRequestsapprovedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdmininviteRequestsapprovedEntity)
  self._name = "admininvite_requestsapproved"
  self._client = client
...
function AdmininviteRequestsapprovedEntity:get_name()
  return self._name
end


function AdmininviteRequestsapprovedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdmininviteRequestsapprovedEntity.new(self._client, opts)
end
...
function AdmininviteRequestsapprovedEntity:mark_deleted()
  self._deleted = true
end


function AdmininviteRequestsapprovedEntity:deleted()
  return true == self._deleted
end


function AdmininviteRequestsapprovedEntity:data_set(args)
  if args ~= nil then
...
function AdmininviteRequestsapprovedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdmininviteRequestsapprovedEntity:match_set(args)
  if args ~= nil then
...
function AdmininviteRequestsapprovedEntity:match_get()
...
function AdmininviteRequestsapprovedEntity:stream(action, args, callopts)
...
---@param reqmatch AdmininviteRequestsapprovedLoadMatch
---@param ctrl? table
---@return AdmininviteRequestsapproved
---@return string? err
function AdmininviteRequestsapprovedEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AdmininviteRequestsapprovedEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AdmininviteRequestsapprovedEntity
