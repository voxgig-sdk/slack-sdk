...
local AdminusergroupEntity = {}
AdminusergroupEntity.__index = AdminusergroupEntity


function AdminusergroupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminusergroupEntity)
  self._name = "adminusergroup"
  self._client = client
...
function AdminusergroupEntity:get_name()
  return self._name
end


function AdminusergroupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminusergroupEntity.new(self._client, opts)
end
...
function AdminusergroupEntity:mark_deleted()
  self._deleted = true
end


function AdminusergroupEntity:deleted()
  return true == self._deleted
end


function AdminusergroupEntity:data_set(args)
  if args ~= nil then
...
function AdminusergroupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminusergroupEntity:match_set(args)
  if args ~= nil then
...
function AdminusergroupEntity:match_get()
...
function AdminusergroupEntity:stream(action, args, callopts)
...
---@param reqmatch AdminusergroupLoadMatch
---@param ctrl? table
---@return Adminusergroup
---@return string? err
function AdminusergroupEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AdminusergroupCreateData
---@param ctrl? table
---@return Adminusergroup
---@return string? err
function AdminusergroupEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function AdminusergroupEntity:_run_op(ctx, post_done)
  local utility = self._utility
