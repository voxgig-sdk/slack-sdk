...
local UsergroupsuserEntity = {}
UsergroupsuserEntity.__index = UsergroupsuserEntity


function UsergroupsuserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UsergroupsuserEntity)
  self._name = "usergroupsuser"
  self._client = client
...
function UsergroupsuserEntity:get_name()
  return self._name
end


function UsergroupsuserEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UsergroupsuserEntity.new(self._client, opts)
end
...
function UsergroupsuserEntity:mark_deleted()
  self._deleted = true
end


function UsergroupsuserEntity:deleted()
  return true == self._deleted
end


function UsergroupsuserEntity:data_set(args)
  if args ~= nil then
...
function UsergroupsuserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UsergroupsuserEntity:match_set(args)
  if args ~= nil then
...
function UsergroupsuserEntity:match_get()
...
function UsergroupsuserEntity:stream(action, args, callopts)
...
---@param reqmatch UsergroupsuserListMatch
---@param ctrl? table
---@return Usergroupsuser[]
---@return string? err
function UsergroupsuserEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata UsergroupsuserCreateData
---@param ctrl? table
---@return Usergroupsuser
---@return string? err
function UsergroupsuserEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function UsergroupsuserEntity:_run_op(ctx, post_done)
  local utility = self._utility
