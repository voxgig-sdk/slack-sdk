...
local AppseventauthorizationEntity = {}
AppseventauthorizationEntity.__index = AppseventauthorizationEntity


function AppseventauthorizationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AppseventauthorizationEntity)
  self._name = "appseventauthorization"
  self._client = client
...
function AppseventauthorizationEntity:get_name()
  return self._name
end


function AppseventauthorizationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AppseventauthorizationEntity.new(self._client, opts)
end
...
function AppseventauthorizationEntity:mark_deleted()
  self._deleted = true
end


function AppseventauthorizationEntity:deleted()
  return true == self._deleted
end


function AppseventauthorizationEntity:data_set(args)
  if args ~= nil then
...
function AppseventauthorizationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AppseventauthorizationEntity:match_set(args)
  if args ~= nil then
...
function AppseventauthorizationEntity:match_get()
...
function AppseventauthorizationEntity:stream(action, args, callopts)
...
---@param reqmatch AppseventauthorizationLoadMatch
---@param ctrl? table
---@return Appseventauthorization
---@return string? err
function AppseventauthorizationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AppseventauthorizationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AppseventauthorizationEntity
