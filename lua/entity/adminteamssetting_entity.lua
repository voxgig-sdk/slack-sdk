...
local AdminteamssettingEntity = {}
AdminteamssettingEntity.__index = AdminteamssettingEntity


function AdminteamssettingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminteamssettingEntity)
  self._name = "adminteamssetting"
  self._client = client
...
function AdminteamssettingEntity:get_name()
  return self._name
end


function AdminteamssettingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminteamssettingEntity.new(self._client, opts)
end
...
function AdminteamssettingEntity:mark_deleted()
  self._deleted = true
end


function AdminteamssettingEntity:deleted()
  return true == self._deleted
end


function AdminteamssettingEntity:data_set(args)
  if args ~= nil then
...
function AdminteamssettingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminteamssettingEntity:match_set(args)
  if args ~= nil then
...
function AdminteamssettingEntity:match_get()
...
function AdminteamssettingEntity:stream(action, args, callopts)
...
---@param reqmatch AdminteamssettingLoadMatch
---@param ctrl? table
---@return Adminteamssetting
---@return string? err
function AdminteamssettingEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AdminteamssettingCreateData
---@param ctrl? table
---@return Adminteamssetting
---@return string? err
function AdminteamssettingEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function AdminteamssettingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AdminteamssettingEntity
