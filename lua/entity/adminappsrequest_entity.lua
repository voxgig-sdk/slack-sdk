...
local AdminappsrequestEntity = {}
AdminappsrequestEntity.__index = AdminappsrequestEntity


function AdminappsrequestEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminappsrequestEntity)
  self._name = "adminappsrequest"
  self._client = client
...
function AdminappsrequestEntity:get_name()
  return self._name
end


function AdminappsrequestEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminappsrequestEntity.new(self._client, opts)
end
...
function AdminappsrequestEntity:mark_deleted()
  self._deleted = true
end


function AdminappsrequestEntity:deleted()
  return true == self._deleted
end


function AdminappsrequestEntity:data_set(args)
  if args ~= nil then
...
function AdminappsrequestEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminappsrequestEntity:match_set(args)
  if args ~= nil then
...
function AdminappsrequestEntity:match_get()
...
function AdminappsrequestEntity:stream(action, args, callopts)
...
---@param reqmatch AdminappsrequestLoadMatch
---@param ctrl? table
---@return Adminappsrequest
---@return string? err
function AdminappsrequestEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AdminappsrequestEntity:_run_op(ctx, post_done)
  local utility = self._utility
