...
local UsergroupEntity = {}
UsergroupEntity.__index = UsergroupEntity


function UsergroupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UsergroupEntity)
  self._name = "usergroup"
  self._client = client
...
function UsergroupEntity:get_name()
  return self._name
end


function UsergroupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UsergroupEntity.new(self._client, opts)
end
...
function UsergroupEntity:mark_deleted()
  self._deleted = true
end


function UsergroupEntity:deleted()
  return true == self._deleted
end


function UsergroupEntity:data_set(args)
  if args ~= nil then
...
function UsergroupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UsergroupEntity:match_set(args)
  if args ~= nil then
...
function UsergroupEntity:match_get()
...
function UsergroupEntity:stream(action, args, callopts)
...
---@param reqmatch UsergroupListMatch
---@param ctrl? table
---@return Usergroup[]
---@return string? err
function UsergroupEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata UsergroupCreateData
---@param ctrl? table
---@return Usergroup
---@return string? err
function UsergroupEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function UsergroupEntity:_run_op(ctx, post_done)
  local utility = self._utility
