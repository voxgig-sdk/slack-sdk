...
local AdmininviteRequestEntity = {}
AdmininviteRequestEntity.__index = AdmininviteRequestEntity


function AdmininviteRequestEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdmininviteRequestEntity)
  self._name = "admininvite_request"
  self._client = client
...
function AdmininviteRequestEntity:get_name()
  return self._name
end


function AdmininviteRequestEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdmininviteRequestEntity.new(self._client, opts)
end
...
function AdmininviteRequestEntity:mark_deleted()
  self._deleted = true
end


function AdmininviteRequestEntity:deleted()
  return true == self._deleted
end


function AdmininviteRequestEntity:data_set(args)
  if args ~= nil then
...
function AdmininviteRequestEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdmininviteRequestEntity:match_set(args)
  if args ~= nil then
...
function AdmininviteRequestEntity:match_get()
...
function AdmininviteRequestEntity:stream(action, args, callopts)
...
---@param reqmatch AdmininviteRequestLoadMatch
---@param ctrl? table
---@return AdmininviteRequest
---@return string? err
function AdmininviteRequestEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AdmininviteRequestCreateData
---@param ctrl? table
---@return AdmininviteRequest
---@return string? err
function AdmininviteRequestEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function AdmininviteRequestEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AdmininviteRequestEntity
