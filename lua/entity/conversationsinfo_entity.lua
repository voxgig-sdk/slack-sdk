...
local ConversationsinfoEntity = {}
ConversationsinfoEntity.__index = ConversationsinfoEntity


function ConversationsinfoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsinfoEntity)
  self._name = "conversationsinfo"
  self._client = client
...
function ConversationsinfoEntity:get_name()
  return self._name
end


function ConversationsinfoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsinfoEntity.new(self._client, opts)
end
...
function ConversationsinfoEntity:mark_deleted()
  self._deleted = true
end


function ConversationsinfoEntity:deleted()
  return true == self._deleted
end


function ConversationsinfoEntity:data_set(args)
  if args ~= nil then
...
function ConversationsinfoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsinfoEntity:match_set(args)
  if args ~= nil then
...
function ConversationsinfoEntity:match_get()
...
function ConversationsinfoEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsinfoLoadMatch
---@param ctrl? table
---@return Conversationsinfo
---@return string? err
function ConversationsinfoEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsinfoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsinfoEntity
