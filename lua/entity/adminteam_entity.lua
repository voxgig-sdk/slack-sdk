...
local AdminteamEntity = {}
AdminteamEntity.__index = AdminteamEntity


function AdminteamEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminteamEntity)
  self._name = "adminteam"
  self._client = client
...
function AdminteamEntity:get_name()
  return self._name
end


function AdminteamEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminteamEntity.new(self._client, opts)
end
...
function AdminteamEntity:mark_deleted()
  self._deleted = true
end


function AdminteamEntity:deleted()
  return true == self._deleted
end


function AdminteamEntity:data_set(args)
  if args ~= nil then
...
function AdminteamEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminteamEntity:match_set(args)
  if args ~= nil then
...
function AdminteamEntity:match_get()
...
function AdminteamEntity:stream(action, args, callopts)
...
---@param reqmatch AdminteamLoadMatch
---@param ctrl? table
---@return Adminteam
---@return string? err
function AdminteamEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AdminteamCreateData
---@param ctrl? table
---@return Adminteam
---@return string? err
function AdminteamEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function AdminteamEntity:_run_op(ctx, post_done)
  local utility = self._utility
