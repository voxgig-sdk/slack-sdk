...
local AdminuserssessionEntity = {}
AdminuserssessionEntity.__index = AdminuserssessionEntity


function AdminuserssessionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdminuserssessionEntity)
  self._name = "adminuserssession"
  self._client = client
...
function AdminuserssessionEntity:get_name()
  return self._name
end


function AdminuserssessionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdminuserssessionEntity.new(self._client, opts)
end
...
function AdminuserssessionEntity:mark_deleted()
  self._deleted = true
end


function AdminuserssessionEntity:deleted()
  return true == self._deleted
end


function AdminuserssessionEntity:data_set(args)
  if args ~= nil then
...
function AdminuserssessionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdminuserssessionEntity:match_set(args)
  if args ~= nil then
...
function AdminuserssessionEntity:match_get()
...
function AdminuserssessionEntity:stream(action, args, callopts)
...
---@param reqdata AdminuserssessionCreateData
---@param ctrl? table
---@return Adminuserssession
---@return string? err
function AdminuserssessionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function AdminuserssessionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AdminuserssessionEntity
