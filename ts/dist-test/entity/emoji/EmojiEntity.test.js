...
(0, node_test_1.describe)('EmojiEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != emoji_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const env = (0, utility_1.envOverride)({
        'SLACK_TEST_EMOJI_ENTID': idmap,
        'SLACK_TEST_LIVE': 'FALSE',
        'SLACK_TEST_EXPLAIN': 'FALSE',
        'SLACK_APIKEY': '',
    });
    idmap = env['SLACK_TEST_EMOJI_ENTID'];
    const live = 'TRUE' === env.SLACK_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['SLACK_TEST_EMOJI_ENTID'];
