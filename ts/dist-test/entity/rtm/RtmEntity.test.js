...
(0, node_test_1.describe)('RtmEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'rtm.' + op, live))
                return;
        }
        ...
        let rtm_ref01_data = Object.values(setup.data.existing.rtm)[0];
        // LOAD
        const rtm_ref01_ent = client.Rtm();
        const rtm_ref01_match_dt0 = {};
        const rtm_ref01_data_dt0 = (await rtm_ref01_ent.load(rtm_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != rtm_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/rtm/RtmTestData.json');
    ...
    let idmap = transform(['rtm01', 'rtm02', 'rtm03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=RtmEntity.test.js.map