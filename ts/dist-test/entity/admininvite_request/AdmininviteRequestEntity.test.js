...
(0, node_test_1.describe)('AdmininviteRequestEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'admininvite_request.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != admininvite_request_ref01_data);
        // LOAD
        ...
        (0, node_assert_1.default)(null != admininvite_request_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/admininvite_request/AdmininviteRequestTestData.json');
    ...
    let idmap = transform(['admininvite_request01', 'admininvite_request02', 'admininvite_request03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AdmininviteRequestEntity.test.js.map