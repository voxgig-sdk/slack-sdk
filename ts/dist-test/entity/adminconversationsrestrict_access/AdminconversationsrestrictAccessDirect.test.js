...
(0, node_test_1.describe)('AdminconversationsrestrictAccessDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-adminconversationsrestrict_access', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-adminconversationsrestrict_access', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SLACK_TEST_ADMINCONVERSATIONSRESTRICT_ACCESS_ENTID'];
...
//# sourceMappingURL=AdminconversationsrestrictAccessDirect.test.js.map