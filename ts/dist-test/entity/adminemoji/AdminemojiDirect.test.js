...
(0, node_test_1.describe)('AdminemojiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-adminemoji', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-adminemoji', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SLACK_TEST_ADMINEMOJI_ENTID'];
...
//# sourceMappingURL=AdminemojiDirect.test.js.map