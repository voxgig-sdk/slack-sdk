...
(0, node_test_1.describe)('ChatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-chat', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-chat', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SLACK_TEST_CHAT_ENTID'];
...
//# sourceMappingURL=ChatDirect.test.js.map