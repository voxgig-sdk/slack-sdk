...
(0, node_test_1.describe)('AdminappsrestrictedEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'adminappsrestricted.' + op, live))
                return;
        }
        ...
        let adminappsrestricted_ref01_data = Object.values(setup.data.existing.adminappsrestricted)[0];
        // LOAD
        const adminappsrestricted_ref01_ent = client.Adminappsrestricted();
        const adminappsrestricted_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != adminappsrestricted_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/adminappsrestricted/AdminappsrestrictedTestData.json');
    ...
    let idmap = transform(['adminappsrestricted01', 'adminappsrestricted02', 'adminappsrestricted03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AdminappsrestrictedEntity.test.js.map