...
(0, node_test_1.describe)('AdminconversationsekmEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'adminconversationsekm.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != adminconversationsekm_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/adminconversationsekm/AdminconversationsekmTestData.json');
    ...
    let idmap = transform(['adminconversationsekm01', 'adminconversationsekm02', 'adminconversationsekm03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AdminconversationsekmEntity.test.js.map