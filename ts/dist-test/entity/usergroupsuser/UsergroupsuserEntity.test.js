...
(0, node_test_1.describe)('UsergroupsuserEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != usergroupsuser_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(usergroupsuser_ref01_list, { id: usergroupsuser_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/usergroupsuser/UsergroupsuserTestData.json');
    ...
    let idmap = transform(['usergroupsuser01', 'usergroupsuser02', 'usergroupsuser03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UsergroupsuserEntity.test.js.map