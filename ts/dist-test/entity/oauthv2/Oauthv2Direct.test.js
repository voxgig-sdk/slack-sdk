...
(0, node_test_1.describe)('Oauthv2Direct', async () => {
    ...
    (0, node_test_1.test)('direct-load-oauthv2', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-oauthv2', setup.live))
            return;
...
//# sourceMappingURL=Oauthv2Direct.test.js.map