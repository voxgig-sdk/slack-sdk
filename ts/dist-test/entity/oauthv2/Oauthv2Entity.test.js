...
(0, node_test_1.describe)('Oauthv2Entity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'oauthv2.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != oauthv2_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/oauthv2/Oauthv2TestData.json');
    ...
    let idmap = transform(['oauthv201', 'oauthv202', 'oauthv203'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=Oauthv2Entity.test.js.map