...
(0, node_test_1.describe)('ChatscheduledMessageEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/chatscheduled_message/ChatscheduledMessageTestData.json');
    ...
    let idmap = transform(['chatscheduled_message01', 'chatscheduled_message02', 'chatscheduled_message03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ChatscheduledMessageEntity.test.js.map