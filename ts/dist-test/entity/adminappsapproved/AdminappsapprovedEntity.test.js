...
(0, node_test_1.describe)('AdminappsapprovedEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'adminappsapproved.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != adminappsapproved_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/adminappsapproved/AdminappsapprovedTestData.json');
    ...
    let idmap = transform(['adminappsapproved01', 'adminappsapproved02', 'adminappsapproved03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AdminappsapprovedEntity.test.js.map