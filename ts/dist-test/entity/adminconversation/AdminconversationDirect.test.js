...
(0, node_test_1.describe)('AdminconversationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-adminconversation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-adminconversation', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-adminconversation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-adminconversation', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SlackSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.SLACK_APIKEY,
        }));
        let idmap = env['SLACK_TEST_ADMINCONVERSATION_ENTID'];
...
//# sourceMappingURL=AdminconversationDirect.test.js.map