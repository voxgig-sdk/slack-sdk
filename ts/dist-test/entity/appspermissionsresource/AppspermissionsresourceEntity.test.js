...
(0, node_test_1.describe)('AppspermissionsresourceEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'appspermissionsresource.' + op, live))
                return;
        }
        ...
        let appspermissionsresource_ref01_data = Object.values(setup.data.existing.appspermissionsresource)[0];
        // LIST
        const appspermissionsresource_ref01_ent = client.Appspermissionsresource();
        const appspermissionsresource_ref01_match = {};
        const appspermissionsresource_ref01_list = (await appspermissionsresource_ref01_ent.list(appspermissionsresource_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/appspermissionsresource/AppspermissionsresourceTestData.json');
    ...
    let idmap = transform(['appspermissionsresource01', 'appspermissionsresource02', 'appspermissionsresource03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AppspermissionsresourceEntity.test.js.map