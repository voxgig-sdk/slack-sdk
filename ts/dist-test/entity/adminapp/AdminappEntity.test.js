...
(0, node_test_1.describe)('AdminappEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        // CREATE
        const adminapp_ref01_ent = client.Adminapp();
        let adminapp_ref01_data = setup.data.new.adminapp['adminapp_ref01'];
        adminapp_ref01_data = (await adminapp_ref01_ent.create(adminapp_ref01_data)).data();
        (0, node_assert_1.default)(null != adminapp_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/adminapp/AdminappTestData.json');
    ...
    let idmap = transform(['adminapp01', 'adminapp02', 'adminapp03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'SLACK_TEST_ADMINAPP_ENTID': idmap,
        'SLACK_TEST_LIVE': 'FALSE',
        'SLACK_TEST_EXPLAIN': 'FALSE',
        'SLACK_APIKEY': '',
    });
    idmap = env['SLACK_TEST_ADMINAPP_ENTID'];
    const live = 'TRUE' === env.SLACK_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['SLACK_TEST_ADMINAPP_ENTID'];
...
//# sourceMappingURL=AdminappEntity.test.js.map