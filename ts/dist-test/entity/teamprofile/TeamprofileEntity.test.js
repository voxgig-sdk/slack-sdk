...
(0, node_test_1.describe)('TeamprofileEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/teamprofile/TeamprofileTestData.json');
    ...
    let idmap = transform(['teamprofile01', 'teamprofile02', 'teamprofile03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=TeamprofileEntity.test.js.map