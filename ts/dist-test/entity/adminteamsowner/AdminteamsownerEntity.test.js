...
(0, node_test_1.describe)('AdminteamsownerEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/adminteamsowner/AdminteamsownerTestData.json');
    ...
    let idmap = transform(['adminteamsowner01', 'adminteamsowner02', 'adminteamsowner03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'SLACK_TEST_ADMINTEAMSOWNER_ENTID': idmap,
        'SLACK_TEST_LIVE': 'FALSE',
        'SLACK_TEST_EXPLAIN': 'FALSE',
        'SLACK_APIKEY': '',
    });
    idmap = env['SLACK_TEST_ADMINTEAMSOWNER_ENTID'];
    const live = 'TRUE' === env.SLACK_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['SLACK_TEST_ADMINTEAMSOWNER_ENTID'];
...
//# sourceMappingURL=AdminteamsownerEntity.test.js.map