...
function basicSetup(extra) {
    ...
    let idmap = transform(['migration01', 'migration02', 'migration03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
