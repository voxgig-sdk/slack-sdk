...
(0, node_test_1.describe)('AdminappsrequestEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'adminappsrequest.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != adminappsrequest_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/adminappsrequest/AdminappsrequestTestData.json');
    ...
    let idmap = transform(['adminappsrequest01', 'adminappsrequest02', 'adminappsrequest03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AdminappsrequestEntity.test.js.map