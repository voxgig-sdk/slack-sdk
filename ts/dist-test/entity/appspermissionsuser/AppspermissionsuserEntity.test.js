...
(0, node_test_1.describe)('AppspermissionsuserEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'appspermissionsuser.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != appspermissionsuser_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/appspermissionsuser/AppspermissionsuserTestData.json');
    ...
    let idmap = transform(['appspermissionsuser01', 'appspermissionsuser02', 'appspermissionsuser03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AppspermissionsuserEntity.test.js.map