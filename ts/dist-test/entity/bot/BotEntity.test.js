...
(0, node_test_1.describe)('BotEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(bot_ref01_data_dt0.id === bot_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/bot/BotTestData.json');
    ...
    let idmap = transform(['bot01', 'bot02', 'bot03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=BotEntity.test.js.map