...
(0, node_test_1.describe)('CallsparticipantEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        // CREATE
        const callsparticipant_ref01_ent = client.Callsparticipant();
        let callsparticipant_ref01_data = setup.data.new.callsparticipant['callsparticipant_ref01'];
        callsparticipant_ref01_data = (await callsparticipant_ref01_ent.create(callsparticipant_ref01_data)).data();
        (0, node_assert_1.default)(null != callsparticipant_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/callsparticipant/CallsparticipantTestData.json');
    ...
    let idmap = transform(['callsparticipant01', 'callsparticipant02', 'callsparticipant03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'SLACK_TEST_CALLSPARTICIPANT_ENTID': idmap,
        'SLACK_TEST_LIVE': 'FALSE',
        'SLACK_TEST_EXPLAIN': 'FALSE',
        'SLACK_APIKEY': '',
    });
    idmap = env['SLACK_TEST_CALLSPARTICIPANT_ENTID'];
    const live = 'TRUE' === env.SLACK_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['SLACK_TEST_CALLSPARTICIPANT_ENTID'];
...
//# sourceMappingURL=CallsparticipantEntity.test.js.map