...
(0, node_test_1.describe)('AdminteamEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'adminteam.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != adminteam_ref01_data);
        // LOAD
        const adminteam_ref01_match_dt0 = {};
        const adminteam_ref01_data_dt0 = (await adminteam_ref01_ent.load(adminteam_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != adminteam_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/adminteam/AdminteamTestData.json');
    ...
    let idmap = transform(['adminteam01', 'adminteam02', 'adminteam03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AdminteamEntity.test.js.map