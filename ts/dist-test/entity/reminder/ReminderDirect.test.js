...
(0, node_test_1.describe)('ReminderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-reminder', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-reminder', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-reminder', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-reminder', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SLACK_TEST_REMINDER_ENTID'];
...
//# sourceMappingURL=ReminderDirect.test.js.map