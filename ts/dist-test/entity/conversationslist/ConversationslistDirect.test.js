...
(0, node_test_1.describe)('ConversationslistDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-conversationslist', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-conversationslist', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SLACK_TEST_CONVERSATIONSLIST_ENTID'];
...
//# sourceMappingURL=ConversationslistDirect.test.js.map