...
(0, node_test_1.describe)('ConversationslistEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'conversationslist.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/conversationslist/ConversationslistTestData.json');
    ...
    let idmap = transform(['conversationslist01', 'conversationslist02', 'conversationslist03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['SLACK_TEST_CONVERSATIONSLIST_ENTID'];
...
//# sourceMappingURL=ConversationslistEntity.test.js.map