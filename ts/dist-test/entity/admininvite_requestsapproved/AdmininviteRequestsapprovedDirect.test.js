...
(0, node_test_1.describe)('AdmininviteRequestsapprovedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-admininvite_requestsapproved', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-admininvite_requestsapproved', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SLACK_TEST_ADMININVITE_REQUESTSAPPROVED_ENTID'];
...
//# sourceMappingURL=AdmininviteRequestsapprovedDirect.test.js.map