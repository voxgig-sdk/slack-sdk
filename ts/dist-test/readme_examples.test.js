...
const TEST_SEED = { "entity": { "adminapp": { "test01": { "id": "test01" } }, "adminappsapproved": { "test01": { "id": "test01" } }, "adminappsrequest": { "test01": { "id": "test01" } }, "adminappsrestricted": { "test01": { "id": "test01" } }, "adminconversation": { "test01": { "id": "test01" } }, "adminconversationsekm": { "test01": { "id": "test01" } }, "adminconversationsrestrict_access": { "test01": { "id": "test01" } }, "adminemoji": { "test01": { "id": "test01" } }, "admininvite_request": { "test01": { "id": "test01" } }, "admininvite_requestsapproved": { "test01": { "id": "test01" } }, "admininvite_requestsdenied": { "test01": { "id": "test01" } }, "adminteam": { "test01": { "id": "test01" } }, "adminteamsadmin": { "test01": { "id": "test01" } }, "adminteamsowner": { "test01": { "id": "test01" } }, "adminteamssetting": { "test01": { "id": "test01" } }, "adminuser": { "test01": { "id": "test01" } }, "adminusergroup": { "test01": { "id": "test01" } }, "adminuserssession": { "test01": { "id": "test01" } }, "api": { "test01": { "id": "test01" } }, "app": { "test01": { "id": "test01" } }, "appseventauthorization": { "test01": { "id": "test01" } }, "appspermission": { "test01": { "id": "test01" } }, "appspermissionsresource": { "test01": { "id": "test01" } }, "appspermissionsscope": { "test01": { "id": "test01" } }, "appspermissionsuser": { "test01": { "id": "test01" } }, "auth": { "test01": { "id": "test01" } }, "bot": { "test01": { "id": "test01" } }, "call": { "test01": { "id": "test01" } }, "callsparticipant": { "test01": { "id": "test01" } }, "chat": { "test01": { "id": "test01" } }, "chatscheduled_message": { "test01": { "id": "test01" } }, "conversation": { "test01": { "id": "test01" } }, "dialog": { "test01": { "id": "test01" } }, "dnd": { "test01": { "id": "test01" } }, "emoji": { "test01": { "id": "test01" } }, "file": { "test01": { "id": "test01" } }, "filescomment": { "test01": { "id": "test01" } }, "filesremote": { "test01": { "id": "test01" } }, "migration": { "test01": { "id": "test01" } }, "oauth": { "test01": { "id": "test01" } }, "oauthv2": { "test01": { "id": "test01" } }, "pin": { "test01": { "id": "test01" } }, "reaction": { "test01": { "id": "test01" } }, "reminder": { "test01": { "id": "test01" } }, "rtm": { "test01": { "id": "test01" } }, "search": { "test01": { "id": "test01" } }, "star": { "test01": { "id": "test01" } }, "team": { "test01": { "id": "test01" } }, "teamprofile": { "test01": { "id": "test01" } }, "user": { "test01": { "id": "test01" } }, "usergroup": { "test01": { "id": "test01" } }, "usergroupsuser": { "test01": { "id": "test01" } }, "usersprofile": { "test01": { "id": "test01" } }, "view": { "test01": { "id": "test01" } }, "workflow": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+SlackSDK\b/.test(code) ||
        /\bSlackSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+SlackSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/SlackSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
