...
describe('ConversationsinfoDirect', async () => {
  ...
  test('direct-load-conversationsinfo', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-conversationsinfo', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['SLACK_TEST_CONVERSATIONSINFO_ENTID']
